...
(function() {
        ...
        var a = /(^|.*[\\\/])ckeditor\.js(?:\?.*|;.*)?$/i,
            d = {
                ...
                basePath: function() {
                    ...
                    if (!c)
                        for (var b = document.getElementsByTagName("script"), d = 0; d < b.length; d++) { var g = b[d].src.match(a); if (g) { c = g[1]; break } } - 1 == c.indexOf(":/") && "//" != c.slice(0, 2) && (c = 0 === c.indexOf("/") ? location.href.match(/^.*?:\/\/[^\/]*/)[0] +
                ...
                domReady: function() {
                    ...
                    return function(c) {
                        function d() {
                            try { document.documentElement.doScroll("left") } catch (c) { setTimeout(d, 1); return }
                            a()
                        }
                        b.push(c);
                        ...
                        if (1 == b.length)
                            ...
                            c = !1;
                            try { c = !window.frameElement } catch (h) {}
                            document.documentElement.doScroll && c && d()
                        }
                    }
                }()
            },
    ...
    CKEDITOR.event || (CKEDITOR.event = function() {}, CKEDITOR.event.implementOn = function(a) {
        ...
        return {
            ...
            on: function(b, d, h, k, g) {
                function l(a, z, w, e) { a = { name: b, sender: this, editor: a, data: z, listenerData: k, stop: w, cancel: e, removeListener: v }; return !1 === d.call(h, a) ? !1 : a.data }

                function v() { z.removeListener(b, d) }
                var e = a.call(this, b);
                if (0 > e.getListenerIndex(d)) {
                    ...
                    for (var w = e.length - 1; 0 <= w; w--)
                        if (e[w].priority <= g) return e.splice(w + 1, 0, l), { removeListener: v };
                    e.unshift(l)
                }
            ...
            fire: function() {
                ...
                return function(g, l, v) {
                    ...
                    if (e) {
                        var w = e.listeners;
                        if (w.length)
                            for (var w = w.slice(0), A, F = 0; F < w.length; F++) {
                                if (e.errorProof) try {
                                    A =
                                        w[F].call(this, v, l, b, k)
                                } catch (u) {} else A = w[F].call(this, v, l, b, k);
                                !1 === A ? h = 1 : "undefined" != typeof A && (l = A);
                                if (a || h) break
                            }
                    }
    ...
    (function() {
        function a(a, w, b) {
            ...
            this.input = function() {
                ...
                if (!c._scheduledTimer || !1 !== c._reschedule()) {
                    var z = (new Date).getTime() - c._lastOutput;
                    z < c._minInterval ? c._scheduledTimer = setTimeout(a, c._minInterval - z) : a()
                }
            }
        }
        ...
        function d(z, b, c) {
            ...
            this.input = CKEDITOR.tools.override(this.input,
                function(a) {
                    return function() {
                        e._args = Array.prototype.slice.call(arguments);
                        a.call(this)
                    }
                })
        }
        var b = [],
            ...
            v = { lt: "\x3c", gt: "\x3e", amp: "\x26", quot: '"', nbsp: " ", shy: "­" },
            e = function(a, b) { return "#" == b[0] ? String.fromCharCode(parseInt(b.slice(1), 10)) : v[b] };
        ...
        CKEDITOR.tools = {
            ...
            clone: function(a) {
                var b;
                if (a && a instanceof Array) { b = []; for (var c = 0; c < a.length; c++) b[c] = CKEDITOR.tools.clone(a[c]); return b }
            ...
            capitalize: function(a, b) { return a.charAt(0).toUpperCase() + (b ? a.slice(1) : a.slice(1).toLowerCase()) },
            extend: function(a) {
                var b = arguments.length,
                    c, e;
                "boolean" == typeof(c = arguments[b - 1]) ? b-- : "boolean" == typeof(c = arguments[b - 2]) && (e = arguments[b - 1], b -= 2);
                for (var g = 1; g < b; g++) {
                    var m = arguments[g] || {};
            ...
            cssStyleToDomStyle: function() {
                var a = document.createElement("div").style,
                    ...
                    "float";
                return function(a) { return "float" == a ? b : a.replace(/-./g, function(a) { return a.substr(1).toUpperCase() }) }
            }(),
            buildStyleHtml: function(a) {
                a = [].concat(a);
                for (var b, c = [], e = 0; e < a.length; e++)
                    if (b = a[e]) /@import|[{}]/.test(b) ? c.push("\x3cstyle\x3e" + b + "\x3c/style\x3e") : c.push('\x3clink type\x3d"text/css" rel\x3dstylesheet href\x3d"' + b + '"\x3e');
                return c.join("")
            },
            htmlEncode: function(a) { return void 0 === a || null === a ? "" : String(a).replace(f, "\x26amp;").replace(h, "\x26gt;").replace(k, "\x26lt;") },
            ...
            transformPlainTextToHtml: function(a, b) {
                var c = b == CKEDITOR.ENTER_BR,
                    ...
                    e = e.replace(/\t/g, "\x26nbsp;\x26nbsp; \x26nbsp;"),
                    g = b == CKEDITOR.ENTER_P ? "p" : "div";
                if (!c) {
                    var m = /\n{2}/g;
                    if (m.test(e)) var d = "\x3c" + g + "\x3e",
                        l = "\x3c/" + g + "\x3e",
                        e = d + e.replace(m, function() { return l + d }) + l
                }
                e = e.replace(/\n/g, "\x3cbr\x3e");
                c || (e =
                    e.replace(new RegExp("\x3cbr\x3e(?\x3d\x3c/" + g + "\x3e)"), function(a) { return CKEDITOR.tools.repeat(a, 2) }));
                e = e.replace(/^ | $/g, "\x26nbsp;");
                return e = e.replace(/(>|\s) /g, function(a, b) { return b + "\x26nbsp;" }).replace(/ (?=<)/g, "\x26nbsp;")
            },
            getNextNumber: function() { var a = 0; return function() { return ++a } }(),
            getNextId: function() { return "cke_" + this.getNextNumber() },
            getUniqueId: function() { for (var a = "e", b = 0; 8 > b; b++) a += Math.floor(65536 * (1 + Math.random())).toString(16).substring(1); return a },
            override: function(a,
                b) {
                var c = b(a);
            ...
            setTimeout: function(a, b, c, e, g) {
                g || (g = window);
                c || (c = g);
                return g.setTimeout(function() { e ? a.apply(c, [].concat(e)) : a.apply(c) }, b || 0)
            },
            throttle: function(a, b, c) { return new this.buffers.throttle(a, b, c) },
            ...
            indexOf: function(a, b) {
                if ("function" == typeof b)
                    for (var c = 0, e = a.length; c < e; c++) { if (b(a[c])) return c } else {
            ...
            search: function(a, b) { var c = CKEDITOR.tools.indexOf(a, b); return 0 <= c ? a[c] : null },
            bind: function(a, b) { var c = Array.prototype.slice.call(arguments, 2); return function() { return a.apply(b, c.concat(Array.prototype.slice.call(arguments))) } },
            createClass: function(a) {
                ...
                c && (b.prototype = this.prototypedCopy(c.prototype), b.prototype.constructor = b, b.base = c, b.baseProto = c.prototype, b.prototype.base = function y() {
            ...
            addFunction: function(a,
                c) { return b.push(function() { return a.apply(c || this, arguments) }) - 1 },
            removeFunction: function(a) { b[a] = null },
            callFunction: function(a) { var c = b[a]; return c && c.apply(window, Array.prototype.slice.call(arguments, 1)) },
            cssLength: function() {
                var a = /^-?\d+\.?\d*px$/,
                    b;
                return function(c) { b = CKEDITOR.tools.trim(c + "") + "px"; return a.test(b) ? b : c || "" }
            }(),
            ...
            tryThese: function() { for (var a, b = 0, c = arguments.length; b < c; b++) { var e = arguments[b]; try { a = e(); break } catch (g) {} } return a },
            ...
            normalizeCssText: function(a, b) {
                var c = [],
                    e, g = CKEDITOR.tools.parseCssText(a, !0, b);
                for (e in g) c.push(e + ":" + g[e]);
                c.sort();
                return c.length ? c.join(";") + ";" : ""
            },
            convertRgbToHex: function(a) { return a.replace(/(?:rgb\(\s*(\d+)\s*,\s*(\d+)\s*,\s*(\d+)\s*\))/gi, function(a, b, c, e) { a = [b, c, e]; for (b = 0; 3 > b; b++) a[b] = ("0" + parseInt(a[b], 10).toString(16)).slice(-2); return "#" + a.join("") }) },
            ...
            parseCssText: function(a, b, c) {
                ...
                if (!a || ";" == a) return e;
                a.replace(/&quot;/g, '"').replace(/\s*([^:;\s]+)\s*:\s*([^;]+)\s*(?=;|$)/g, function(a, c, z) {
                    b && (c =
                        c.toLowerCase(), "font-family" == c && (z = z.replace(/\s*,\s*/g, ",")), z = CKEDITOR.tools.trim(z));
                    e[c] = z
                });
                return e
            },
            ...
            eventsBuffer: function(a, b, c) { return new this.buffers.event(a, b, c) },
            enableHtml5Elements: function(a, b) { for (var c = "abbr article aside audio bdi canvas data datalist details figcaption figure footer header hgroup main mark meter nav output progress section summary time video".split(" "), e = c.length, g; e--;) g = a.createElement(c[e]), b && a.appendChild(g) },
            ...
            keystrokeToArray: function(a, b) {
                var c = b & 16711680,
                    ...
                    m = [],
                    d = [];
                c & CKEDITOR.CTRL && (m.push(g ? "⌘" : a[17]), d.push(g ? a[224] : a[17]));
                c & CKEDITOR.ALT && (m.push(g ? "⌥" : a[18]), d.push(a[18]));
                c & CKEDITOR.SHIFT && (m.push(g ? "⇧" : a[16]), d.push(a[16]));
                e && (a[e] ? (m.push(a[e]), d.push(a[e])) : (m.push(String.fromCharCode(e)), d.push(String.fromCharCode(e))));
            ...
            getCookie: function(a) {
                a = a.toLowerCase();
                for (var b = document.cookie.split(";"), c, e, g = 0; g < b.length; g++)
                    if (c = b[g].split("\x3d"), e = decodeURIComponent(CKEDITOR.tools.trim(c[0]).toLowerCase()), e === a) return decodeURIComponent(1 < c.length ? c[1] : "");
                return null
            },
            ...
            getCsrfToken: function() {
                ...
                if (!a || 40 != a.length) {
                    ...
                    for (c = 0; c < a.length; c++) var e = "abcdefghijklmnopqrstuvwxyz0123456789".charAt(a[c] % 36),
                        b = b + (.5 < Math.random() ? e.toUpperCase() : e);
                    a = b;
            ...
            normalizeMouseButton: function(a, b) {
                ...
                for (var c = [
                    ...
                    ], e = 0; e < c.length; e++) { var g = c[e]; if (g[0] === a && b) return g[1]; if (!b && g[1] === a) return g[0] }
            },
            convertHexStringToBytes: function(a) {
                var b = [],
                    c = a.length / 2,
                    e;
                for (e = 0; e < c; e++) b.push(parseInt(a.substr(2 * e, 2), 16));
                return b
            },
            ...
            style: {
                parse: {
                    ...
                    margin: function(a) { return CKEDITOR.tools.style.parse.sideShorthand(a, function(a) { return a.match(/(?:\-?[\.\d]+(?:%|\w*)|auto|inherit|initial|unset|revert)/g) || ["0px"] }) },
                    ...
                    border: function(a) { return CKEDITOR.tools.style.border.fromCssRule(a) },
            ...
            array: {
                filter: function(a, b, c) {
                    var e = [];
                    this.forEach(a, function(g, m) { b.call(c, g, m, a) && e.push(g) });
                    return e
                },
                find: function(a, b, c) {
                    for (var e = a.length, g = 0; g < e;) {
                        if (b.call(c, a[g], g, a)) return a[g];
                        g++
                    }
                },
                forEach: function(a, b, c) {
                    var e = a.length,
                        g;
                    for (g = 0; g < e; g++) b.call(c, a[g], g, a)
                },
                map: function(a, b, c) { for (var e = [], g = 0; g < a.length; g++) e.push(b.call(c, a[g], g, a)); return e },
                reduce: function(a, b, c, e) { for (var g = 0; g < a.length; g++) c = b.call(e, c, a[g], g, a); return c },
                ...
                zip: function(a, b) { return CKEDITOR.tools.array.map(a, function(a, c) { return [a, b[c]] }) }
            },
            object: {
                DONT_ENUMS: "toString toLocaleString valueOf hasOwnProperty isPrototypeOf propertyIsEnumerable constructor".split(" "),
                entries: function(a) { return CKEDITOR.tools.array.map(CKEDITOR.tools.object.keys(a), function(b) { return [b, a[b]] }) },
                values: function(a) {
                ...
                keys: function(a) {
                    var b = Object.prototype.hasOwnProperty,
                        c = [],
                        e = CKEDITOR.tools.object.DONT_ENUMS;
                    ...
                    if (CKEDITOR.env.ie && 9 > CKEDITOR.env.version)
                        for (g = 0; g < e.length; g++) b.call(a, e[g]) && c.push(e[g]);
                    return c
                },
                ...
                merge: function(a, b) {
                    var c = CKEDITOR.tools,
                        e = c.clone(a),
                        g = c.clone(b);
                    c.array.forEach(c.object.keys(g), function(a) { e[a] = "object" === typeof g[a] && "object" === typeof e[a] ? c.object.merge(e[a], g[a]) : g[a] });
                    return e
                }
            },
            getAbsoluteRectPosition: function(a, b) {
                function c(a) {
                    if (a) {
                        ...
                        e.top += b.top;
                        e.left += b.left;
                        "x" in e && "y" in e && (e.x += b.x, e.y += b.y);
                        c(a.getWindow().getFrame())
                    }
                }
                var e = CKEDITOR.tools.copy(b);
                c(a.getFrame());
                var g = CKEDITOR.document.getWindow().getScrollPosition();
                e.top += g.y;
                e.left +=
                    g.x;
                "x" in e && "y" in e && (e.y += g.y, e.x += g.x);
        ...
        a.prototype = {
            ...
            _reschedule: function() { return !1 },
            _call: function() { this._output() },
        ...
        d.prototype._reschedule = function() { this._scheduledTimer && this._clearTimer() };
            ...
            _: {
                ...
                normalize: function() {
                    for (var a in this._.normalizeMap) {
                        var b = this[a];
                        b && (this[a] = CKEDITOR.tools.array.reduce(this._.normalizeMap[a], function(a, b) { return a.replace(b[0], b[1]) }, b))
                    }
                }
            },
            proto: {
            ...
            statics: {
                ...
                splitCssValues: function(a, b) {
                    ...
                    var c = CKEDITOR.tools.array.reduce(["width",
                        ...
                        var g = a["border-" + e] || b[e];
                        c[e] = g ? CKEDITOR.tools.style.parse.sideShorthand(g) : null;
                        return c
                    }, {});
                    return CKEDITOR.tools.array.reduce(["top", "right", "bottom", "left"], function(b, e) {
                        var g = {},
                            d;
                        for (d in c) {
                            var l = a["border-" + e + "-" + d];
                        ...
                        b["border-" + e] = new CKEDITOR.tools.style.border(g);
                        return b
                    }, {})
                }
            }
    ...
    CKEDITOR.dom.domObject.prototype = function() {
        ...
        return {
            ...
            removeAllListeners: function() {
                ...
                } catch (f) { if (!CKEDITOR.env.edge || -2146828218 !== f.number) throw f; }
    ...
    CKEDITOR.tools.extend(CKEDITOR.dom.node.prototype, {
        ...
        getAscendant: function(a, d) {
            ...
            for (; b;) { if (c(f ? new CKEDITOR.dom.node(b) : b)) return new CKEDITOR.dom.node(b); try { b = b.parentNode } catch (h) { b = null } }
            return null
        },
    ...
    (function() {
        ...
        CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
            ...
            addClass: f ? function(a) { this.$.classList.add(a); return this } : function(b) {
            ...
            getClientSize: function() { return { width: this.$.clientWidth, height: this.$.clientHeight } },
            ...
            getDocumentPosition: function(a) {
                ...
                if (document.documentElement.getBoundingClientRect && (CKEDITOR.env.ie ?
                    ...
                    k && (CKEDITOR.env.webkit || CKEDITOR.env.ie && 12 <= CKEDITOR.env.version ? (b = d.$.scrollLeft || h.scrollLeft, c = d.$.scrollTop || h.scrollTop) : (c = w ? d.$ : h, b = c.scrollLeft, c = c.scrollTop), b = f.left + b - m, c = f.top + c - u)
                } else
                    for (u = this, m = null; u && "body" != u.getName() &&
                        "html" != u.getName();) {
            ...
            scrollIntoParent: function(a, b, c) {
                ...
                e = d.x + e + m(this, "right") - (y.x + n) || 0;
                d = d.y + G + m(this, "bottom") - (y.y + H) || 0;
                (0 > f || 0 < d) && h(0, !0 === b ? f : !1 === b ? d : 0 > f ? f : d);
                c && (0 > w || 0 < e) && h(0 > w ? w : e, 0)
            },
    ...
    (function() {
        function a(a, b) {
            ...
            if (!a && !this._.guardLTR) {
                var L = e.type == CKEDITOR.NODE_ELEMENT ? e : e.getParent(),
                    B = e.type == CKEDITOR.NODE_ELEMENT ? e.getChild(z) : e.getNext();
            ...
            if (a && !this._.guardRTL) {
                ...
                this._.guardRTL = function(a, b) { return (!b || !k.equals(a)) && (!q || !a.equals(q)) && (a.type != CKEDITOR.NODE_ELEMENT || !b || !a.equals(c.root)) }
            }
            var D = a ? this._.guardRTL : this._.guardLTR;
            h = g ? function(a, b) { return !1 === D(a, b) ? !1 : g(a, b) } : D;
            this.current ? e = this.current[C](!1, n, h) : (a ? e.type == CKEDITOR.NODE_ELEMENT &&
                (e = 0 < z ? e.getChild(z - 1) : !1 === h(e, !0) ? null : e.getPreviousSourceNode(!0, n, h)) : (e = d, e.type == CKEDITOR.NODE_ELEMENT && ((e = e.getChild(f)) || (e = !1 === h(d, !0) ? null : d.getNextSourceNode(!0, n, h)))), e && !1 === h(e) && (e = null));
            for (; e && !this._.end;) {
                this.current = e;
                if (!this.evaluator || !1 !== this.evaluator(e)) { if (!b) return e } else if (b && this.evaluator) return !1;
                e = e[C](!1, n, h)
            }
            this.end();
        ...
        CKEDITOR.dom.walker.invisible =
            function(a) {
                ...
                return function(e) { b(e) ? e = 1 : (e.type == CKEDITOR.NODE_TEXT && (e = e.getParent()), e = e.$.offsetWidth <= c); return !!(a ^ e) }
            };
        ...
        var f = /^[\t\r\n ]*(?:&nbsp;|\xa0)$/,
            ...
            l = function(a) { return k(a) || h(a) || a.type == CKEDITOR.NODE_ELEMENT && a.is(CKEDITOR.dtd.$inline) && !a.is(CKEDITOR.dtd.$empty) };
        ...
        CKEDITOR.dom.walker.editable = function(a) {
            return function(b) {
                b =
                    v(b) ? !1 : b.type == CKEDITOR.NODE_TEXT || b.type == CKEDITOR.NODE_ELEMENT && (b.is(CKEDITOR.dtd.$inline) || b.is("hr") || "false" == b.getAttribute("contenteditable") || !CKEDITOR.env.needsBrFiller && b.is(z) && e(b)) ? !0 : !1;
                return !!(a ^ b)
            }
        };
    ...
    (function() {
        ...
        function d(a, b, c, d, f) {
            function h(a, b, c, e) {
                var E = c ? a.getPrevious() : a.getNext();
                if (e && k) return E;
            ...
            function m() {
                var a, b, c, e = Math.min(S.length, t.length);
                for (a = 0; a < e; a++)
            ...
            function g() {
                var b = P - 1,
                    c = D && r && !n.equals(C);
                b < I - 1 || b < p - 1 || c ? (c ? a.moveToPosition(C,
            ...
            var n = a.startContainer,
                ...
                B = a.endOffset,
                N, q, D, r, x, T;
            if (l && C.type == CKEDITOR.NODE_TEXT && (n.equals(C) || n.type === CKEDITOR.NODE_ELEMENT && n.getFirst().equals(C))) c.append(a.document.createText(C.substring(L, B)));
            else {
                C.type == CKEDITOR.NODE_TEXT ? l ? T = !0 : C = C.split(B) : 0 < C.getChildCount() ? B >= C.getChildCount() ? (C = C.getChild(B - 1), q = !0) : C = C.getChild(B) : r = q = !0;
                n.type == CKEDITOR.NODE_TEXT ? l ? x = !0 : n.split(L) : 0 < n.getChildCount() ? 0 === L ? (n = n.getChild(L), N = !0) : n = n.getChild(L - 1) : D = N = !0;
                for (var S = n.getParents(), t = C.getParents(), P = m(),
                        I = S.length - 1, p = t.length - 1, J = c, E, ba, K, da = -1, U = P; U <= I; U++) {
                    ba = S[U];
                    K = ba.getNext();
                    for (U != I || ba.equals(t[U]) && I < p ? b && (E = J.append(ba.clone(0, f))) : N ? h(ba, J, !1, D) : x && J.append(a.document.createText(ba.substring(L))); K;) {
                        if (K.equals(t[U])) { da = U; break }
                        K = h(K, J)
                    }
                    J = E
                }
                J = c;
                for (U = P; U <= p; U++)
                    if (c = t[U], K = c.getPrevious(), c.equals(S[U])) b && (J = J.getChild(0));
                    else {
                        U != p || c.equals(S[U]) && p < I ? b && (E = J.append(c.clone(0, f))) : q ? h(c, J, !1, r) : T && J.append(a.document.createText(c.substring(0, B)));
                        if (U > da)
                            for (; K;) K = h(K, J, !0);
                        J = E
                    }
        ...
        function b() {
            ...
            return function(f) { return c(f) || b(f) ? !0 : d(f) && !a ? a = !0 : f.type == CKEDITOR.NODE_TEXT && (f.hasAscendant("pre") || CKEDITOR.tools.trim(f.getText()).length) || f.type == CKEDITOR.NODE_ELEMENT && !f.is(h) ? !1 : !0 }
        }
        ...
        function f(a) { return function() { var b; return this[a ? "getPreviousNode" : "getNextNode"](function(a) {!b && v(a) && (b = a); return l(a) && !(k(a) && a.equals(b)) }) } }
        ...
        CKEDITOR.dom.range.prototype = {
            ...
            equals: function(a) { return this.startOffset === a.startOffset && this.endOffset === a.endOffset && this.startContainer.equals(a.startContainer) && this.endContainer.equals(a.endContainer) },
            createBookmark: function(a) {
                ...
                f || (m = h.clone(), m.setHtml("\x26nbsp;"), a && m.setAttribute("id", g + "E"), k = this.clone(), b(d) && (d = b(d),
                    k.moveToPosition(d, CKEDITOR.POSITION_AFTER_END)), k.collapse(), k.insertNode(m));
                k = this.clone();
                b(c) && (d = b(c), k.moveToPosition(d, CKEDITOR.POSITION_BEFORE_START));
                k.collapse(!0);
                k.insertNode(h);
                m ? (this.setStartAfter(h), this.setEndBefore(m)) : this.moveToPosition(h, CKEDITOR.POSITION_AFTER_END);
                return { startNode: a ? g + (f ? "C" : "S") : h, endNode: a ? g + "E" : m, serializable: a, collapsed: f }
            },
            createBookmark2: function() {
                function a(b) {
                    ...
                    if (e.type == CKEDITOR.NODE_ELEMENT && 0 < d) {
                        a: {
                            for (m = e; d--;)
                                if (f = m.getChild(d).getIndex(!0), 0 <= f) { d = f; break a }
                            d = -1
                        }
                        d += 1
                    }
                    if (e.type == CKEDITOR.NODE_TEXT) {
                        ...
                        m = f;
                        e.isEmpty() ? (f = e.getPrevious(c), m ? (d = m, e = f ? f.getNext() : e.getParent().getFirst()) : (e = e.getParent(),
                ...
                return function(c) {
                    ...
                    c && (a(f), b(f, this.root),
                        d || (a(m), b(m, this.root)));
                    return { start: f.container.getAddress(c), end: d ? null : m.container.getAddress(c), startOffset: f.offset, endOffset: m.offset, normalized: c, collapsed: d, is2: !0 }
                }
            }(),
            ...
            enlarge: function(a, b) {
                ...
                switch (a) {
                    ...
                    case CKEDITOR.ENLARGE_ELEMENT:
                        var h = function(a, b) {
                            ...
                            var c = new CKEDITOR.dom.walker(c),
                                e;
                            for (c.guard =
                                function(a) { return !(a.type == CKEDITOR.NODE_ELEMENT && a.isBlockBoundary()) }; e = c.next();) {
                        ...
                        B.type == CKEDITOR.NODE_TEXT ? (q && (B = !CKEDITOR.tools.trim(B.substring(0, q)).length && B, L = !!B), B && ((n = B.getPrevious()) || (l = B.getParent()))) : (q && (n = B.getChild(q - 1) || B.getLast()), n || (l = B));
                        for (l = c(l); l || n;) {
                            if (l && !n) {
                                !C && l.equals(m) && (C = !0);
                                if (f ? l.isBlockBoundary() : !g.contains(l)) break;
                                L && "inline" == l.getComputedStyle("display") || (L = !1, C ? k = l : this.setStartBefore(l));
                                n = l.getPrevious()
                            }
                            for (; n;)
                                if (B = !1, n.type == CKEDITOR.NODE_COMMENT) n = n.getPrevious();
                                else {
                                    if (n.type == CKEDITOR.NODE_TEXT) N = n.getText(), d.test(N) && (n = null), B = /[\s\ufeff]$/.test(N);
                                    else if ((n.$.offsetWidth > (CKEDITOR.env.webkit ? 1 : 0) || b && n.is("br")) && !n.data("cke-bookmark"))
                                        if (L && CKEDITOR.dtd.$removeEmpty[n.getName()]) {
                                            N = n.getText();
                                            if (d.test(N)) n = null;
                                            else
                                                for (var q = n.$.getElementsByTagName("*"), D = 0, r; r = q[D++];)
                                                    if (!CKEDITOR.dtd.$removeEmpty[r.nodeName.toLowerCase()]) { n = null; break }
                                            n && (B = !!N.length)
                                        } else n = null;
                                    B && (L ? C ? k = l : l && this.setStartBefore(l) : L = !0);
                                    if (n) {
                                        B = n.getPrevious();
                                        if (!l && !B) {
                                            l = n;
                        ...
                        l = n = null;
                        C = L = !1;
                        B.type == CKEDITOR.NODE_TEXT ? CKEDITOR.tools.trim(B.substring(q)).length ? L = !0 : (L = !B.getLength(), q == B.getLength() ? (n = B.getNext()) || (l = B.getParent()) :
                            h(B, q) && (l = B.getParent())) : (n = B.getChild(q)) || (l = B);
                        for (; l || n;) {
                            if (l && !n) {
                                !C && l.equals(m) && (C = !0);
                                if (f ? l.isBlockBoundary() : !g.contains(l)) break;
                                L && "inline" == l.getComputedStyle("display") || (L = !1, C ? v = l : l && this.setEndAfter(l));
                                n = l.getNext()
                            }
                            for (; n;) {
                                B = !1;
                                if (n.type == CKEDITOR.NODE_TEXT) N = n.getText(), h(n, 0) || (n = null), B = /^[\s\ufeff]/.test(N);
                                    ...
                                    if ((0 < n.$.offsetWidth || b && n.is("br")) && !n.data("cke-bookmark"))
                                        if (L && CKEDITOR.dtd.$removeEmpty[n.getName()]) {
                                            ...
                                            if (d.test(N)) n =
                                                ...
                                                for (q = n.$.getElementsByTagName("*"), D = 0; r = q[D++];)
                                                    if (!CKEDITOR.dtd.$removeEmpty[r.nodeName.toLowerCase()]) { n = null; break }
                                            n && (B = !!N.length)
                                        } else n = null
                                } else B = 1;
                                B && L && (C ? v = l : this.setEndAfter(l));
                                if (n) {
                                    B = n.getNext();
                                    if (!l && !B) {
                                        l = n;
                        ...
                        k && v && (m = k.contains(v) ? v : k, this.setStartBefore(m), this.setEndAfter(m));
                        break;
                    ...
                    case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
                        ...
                        var x, T, S = CKEDITOR.dom.walker.blockBoundary(a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS ? { br: 1 } : null),
                            t = null,
                            P = function(a) {
                                if (a.type == CKEDITOR.NODE_ELEMENT && "false" == a.getAttribute("contenteditable"))
                                    if (t) { if (t.equals(a)) { t = null; return } } else t = a;
                                else if (t) return;
                                var b = S(a);
                                b || (x = a);
                                return b
                            },
                            f = function(a) { var b = P(a);!b && a.is && a.is("br") && (T = a); return b };
                        l.guard = P;
                        l = l.lastBackward();
                        x = x || g;
                        this.setStartAt(x, !x.is("br") && (!l && this.checkStartOfBlock() || l && x.contains(l)) ? CKEDITOR.POSITION_AFTER_START : CKEDITOR.POSITION_AFTER_END);
                        if (a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS) {
                            l = this.clone();
                            l = new CKEDITOR.dom.walker(l);
                            var I = CKEDITOR.dom.walker.whitespaces(),
                                p = CKEDITOR.dom.walker.bookmark();
                            l.evaluator = function(a) { return !I(a) && !p(a) };
                        ...
                        l = l.lastForward();
                        x = x || g;
                        this.setEndAt(x, !l && this.checkEndOfBlock() || l && x.contains(l) ? CKEDITOR.POSITION_BEFORE_END : CKEDITOR.POSITION_BEFORE_START);
            ...
            splitBlock: function(a, b) {
                ...
                this.deleteContents();
                f && f.equals(h) && (d ? (m = new CKEDITOR.dom.elementPath(this.startContainer, this.root), this.moveToPosition(h, CKEDITOR.POSITION_AFTER_END), h = null) : c ? (m = new CKEDITOR.dom.elementPath(this.startContainer, this.root), this.moveToPosition(f, CKEDITOR.POSITION_BEFORE_START), f = null) : (h = this.splitElement(f, b ||
            ...
            getClientRects: function() {
                function a(b, c) {
                    var d = CKEDITOR.tools.array.map(b, function(a) { return a }),
            ...
            _find: function(a, b) {
                ...
                if (c && c.find)
                    for (m = c.find(a), h = 0; h < m.count(); h++)
                        if (c = m.getItem(h), b || !c.isReadOnly()) g = c.getPosition(d.startNode) & CKEDITOR.POSITION_FOLLOWING || d.startNode.equals(c), k = c.getPosition(d.endNode) & CKEDITOR.POSITION_PRECEDING + CKEDITOR.POSITION_IS_CONTAINED ||
            ...
            getNextParagraph: function(a) {
                ...
                if (!this._.started) {
                    ...
                    u.collapsed || (k = new CKEDITOR.dom.walker(u.clone()), m = CKEDITOR.dom.walker.bookmark(!0, !0), k.evaluator = m, this._.nextNode = k.next(), k = new CKEDITOR.dom.walker(u.clone()), k.evaluator = m, k = k.previous(), this._.lastNode = k.getNextSourceNode(!0, null, u.root), this._.lastNode && this._.lastNode.type == CKEDITOR.NODE_TEXT && !CKEDITOR.tools.trim(this._.lastNode.getText()) && this._.lastNode.getParent().isBlockBoundary() && (m = this.range.clone(), m.moveToPosition(this._.lastNode, CKEDITOR.POSITION_AFTER_END), m.checkEndOfBlock() &&
                        (m = new CKEDITOR.dom.elementPath(m.endContainer, m.root), this._.lastNode = (m.block || m.blockLimit).getNextSourceNode(!0))), this._.lastNode && u.root.contains(this._.lastNode) || (this._.lastNode = this._.docEndMarker = u.document.createText(""), this._.lastNode.insertAfter(k)), u = null);
                    this._.started = 1;
                    k = u
                }
                m = this._.nextNode;
                ...
                for (this._.nextNode = null; m;) {
                    var M = 0,
                        ...
                        G = m.type != CKEDITOR.NODE_ELEMENT,
                        H = 0;
                    if (G) m.type == CKEDITOR.NODE_TEXT && f.test(m.getText()) && (G = 0);
                    else {
                        var n = m.getName();
                        if (CKEDITOR.dtd.$block[n] && "false" == m.getAttribute("contenteditable")) {
                            d = m;
                            b(this, a, d);
                            break
                        } else if (m.isBlockBoundary(this.forceBrBreak && !y && { br: 1 })) {
                            if ("br" == n) G = 1;
                            else if (!k && !m.getChildCount() && "hr" != n) {
                                d = m;
                                w = m.equals(u);
                                break
                            }
                            k && (k.setEndAt(m, CKEDITOR.POSITION_BEFORE_START), "br" != n && (this._.nextNode = m));
                            M = 1
                        } else {
                            if (m.getFirst()) {
                    ...
                    if (k && !M)
                        for (; !m.getNext(g) && !w;) {
                            n = m.getParent();
                            if (n.isBlockBoundary(this.forceBrBreak && !y && { br: 1 })) {
                                M = 1;
                                G = 0;
                                w || n.equals(u);
                                k.setEndAt(n, CKEDITOR.POSITION_BEFORE_END);
                                break
                            }
                            m = n;
                            G = 1;
                    ...
                    G && k.setEndAt(m, CKEDITOR.POSITION_AFTER_END);
                    m = this._getNextSourceNode(m, H, u);
                    if ((w = !m) || M && k) break
                }
                if (!d) {
                ...
                F && (A = d.getLast()) && A.type == CKEDITOR.NODE_ELEMENT && "br" == A.getName() && (!CKEDITOR.env.needsBrFiller || A.getPrevious(h) || A.getNext(h)) && A.remove();
                this._.nextNode || (this._.nextNode = w || d.equals(u) || !u ? null : this._getNextSourceNode(d, 1, u));
                return d
            },
    ...
    (function() {
        function a(a, b, c, d, f) {
            ...
            for (e in b) {
                n = b[e];
                n = "boolean" == typeof n ? {} : "function" == typeof n ? { match: n } : D(n);
                "$" != e.charAt(0) && (n.elements = e);
                ...
                for (q in T) {
                    ...
                    var r = p,
                        ...
                        P = void 0;
                    h ? J = !1 : h = {};
                    for (P in g) "!" == P.charAt(0) && (P = P.slice(1), x.push(P), h[P] = !0, J = !1);
                    for (; P = x.pop();) g[P] =
                        g["!" + P], delete g["!" + P];
                    r[t] = (J ? !1 : h) || null
                }
            ...
            for (d = a.length; c < d; ++c) {
                e = D(a[c]);
                n = !0 === e.classes || !0 === e.styles || !0 === e.attributes;
                p = e;
                q = t = m = void 0;
                for (m in T) p[m] = M(p[m]);
                r = !0;
                for (q in S) {
                    m = S[q];
                    t = p[m];
                    h = [];
                    g = void 0;
                    for (g in t) - 1 < g.indexOf("*") ? h.push(new RegExp("^" + g.replace(/\*/g, ".*") + "$")) : h.push(g);
                    t = h;
                    t.length && (p[m] = t, r = !1)
                }
                p.nothingRequired = r;
                ...
                if (!0 === e.elements ||
                    null === e.elements) f[n ? "unshift" : "push"](e);
                else
                    for (C in p = e.elements, delete e.elements, p)
                        if (b[C]) b[C][n ? "unshift" : "push"](e);
                        else b[C] = [e]
            }
        }
        ...
        function c(a, b, c) {
            if (!a.match || a.match(b)) {
                ...
                b = b.classes;
                if (a) {
                    for (var d = !1, e = !0 === a, n = b.length; n--;)
                        if (e || a(b[n])) b.splice(n, 1), d = !0;
                    a = d
                } else a = !1;
        ...
        function e(a) {
            var b, c, d, f, e = {},
                n = 1;
            for (a = r(a); b = a.match(t);)(c = b[2]) ? (d = z(c, "styles"), f = z(c, "attrs"), c = z(c, "classes")) : d = f = c = null, e["$" + n++] = { elements: b[1], classes: c, styles: d, attributes: f }, a = a.slice(b[0].length);
            return e
        }

        function z(a, b) { var c = a.match(P[b]); return c ? r(c[1]) : null }
        ...
        function A(a, b, f, e) {
            ...
            if (e.doCallbacks && a.elementCallbacks) {
                a: {
                    ...
                    for (var r = 0, h = t.length, g; r < h; ++r)
                        if (g = t[r](b)) { t = g; break a }
                    t = void 0
                }
                if (t) return t
            }
            if (e.doTransform && (t = a._.transformations[b.name])) {
                w(b);
                for (r = 0; r < t.length; ++r) n(a, b, t[r]);
                u(b)
            }
            if (e.doFilter) {
                a: {
                    ...
                    if (a || t) {
                        w(b);
                        if (r)
                            for (x = 0, D = r.length; x < D; ++x)
                                if (!1 === c(r[x], b, k)) { a = null; break a }
                        if (h)
                            for (x = 0, D = h.length; x < D; ++x) c(h[x], b, k);
                        if (a)
                            for (x = 0, D = a.length; x < D; ++x) d(a[x], b, k, g);
                        if (t)
                            for (x = 0, D = t.length; x < D; ++x) d(t[x], b, k, g);
                        a = k
                    } else a = null
                }
                if (!a || !a.valid) return f.push(b), 1;D = a.validAttributes;
                var P = a.validStyles;
                t = a.validClasses;
                var r = b.attributes,
                    J = b.styles,
                ...
                var C = b.styleBackup,
                    B, L, l = [],
                    k = [],
                    N = /^data-cke-/;x = !1;delete r.style;delete r["class"];delete b.classBackup;delete b.styleBackup;
                if (!a.allAttributes)
                    for (B in r) D[B] || (N.test(B) ? B == (L = B.replace(/^data-cke-saved-/, "")) || D[L] || (delete r[B], x = !0) : (delete r[B], x = !0));
                if (!a.allStyles || a.hadInvalidStyle) {
                    for (B in J) a.allStyles || P[B] ? l.push(B + ":" + J[B]) : x = !0;
                    l.length && (r.style = l.sort().join("; "))
                } else C && (r.style = C);
                if (!a.allClasses ||
                    a.hadInvalidClass) {
                    for (B = 0; B < h.length; ++B)(a.allClasses || t[h[B]]) && k.push(h[B]);
                    k.length && (r["class"] = k.sort().join(" "));
                    g && k.length < g.split(/\s+/).length && (x = !0)
                } else g && (r["class"] = g);x && (q = 1);
                if (!e.skipFinalValidation && !m(b)) return f.push(b), 1
            }
            e.toHtml && (b.name = b.name.replace(p, "cke:$1"));
            return q
        }
        ...
        function M(a) { if (!a) return !1; if (!0 === a) return !0; var b = F(a); return function(c) { return c in a || b && c.match(b) } }
        ...
        function H(a, b, c) {
            var d = a.name;
            if (q.$empty[d] || !a.children.length) "hr" == d && "br" == b ? a.replaceWith(y()) : (a.parent && c.push({ check: "it", el: a.parent }), a.remove());
            else if (q.$block[d] || "tr" == d)
                if ("br" == b) a.previous && !G(a.previous) && (b = y(), b.insertBefore(a)), a.next && !G(a.next) && (b = y(), b.insertAfter(a)), a.replaceWithChildren();
                else {
                    var d = a.children,
                        f;
                    b: {
                        f = q[b];
                        for (var e = 0, n = d.length, p; e < n; ++e)
                            if (p = d[e], p.type == CKEDITOR.NODE_ELEMENT && !f[p.name]) { f = !1; break b }
                        f = !0
                    }
                    if (f) a.name = b, a.attributes = {}, c.push({ check: "parent-down", el: a });
                    else {
                        f = a.parent;
                        for (var e = f.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || "body" == f.name, r, m, n = d.length; 0 < n;) p = d[--n], e && (p.type == CKEDITOR.NODE_TEXT || p.type == CKEDITOR.NODE_ELEMENT && q.$inline[p.name]) ? (r || (r = new CKEDITOR.htmlParser.element(b), r.insertAfter(a), c.push({ check: "parent-down", el: r })), r.add(p, 0)) : (r = null, m = q[f.name] || q.span, p.insertAfter(a), f.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || p.type != CKEDITOR.NODE_ELEMENT || m[p.name] || c.push({ check: "el-up", el: p }));
                        a.remove()
                    }
                }
        ...
        function n(a, b, c) {
            ...
            for (d = 0; d < c.length; ++d)
                if (f = c[d], !(f.check && !a.check(f.check, !1) || f.left && !f.left(b))) { f.right(b, J); break }
        }
        ...
        function C(a, b) {
            ...
            for (e in d)
                if ("class" == e)
                    for (c = d[e].split(/\s+/), p = a.classes.join("|"); r = c.pop();) { if (-1 == p.indexOf(r)) return !1 } else if (a.attributes[e] != d[e]) return !1;
            for (n in f)
                if (a.styles[n] !=
                    f[n]) return !1;
            return !0
        ...
        function B(a) { return function(b) { return C(b, a) } }

        function N(a) { return function(b, c) { c[a](b) } }
        var q = CKEDITOR.dtd,
        ...
        CKEDITOR.filter = function(a, b) {
            ...
            if (c && !b) {
                ...
                !0 === d ? this.disabled = !0 : (d || (this.customConfig = !1), this.allow(d, "config", 1), this.allow(c.config.extraAllowedContent, "extra", 1), this.allow(x[c.enterMode] +
        ...
        CKEDITOR.filter.prototype = {
            allow: function(b, c, d) {
                ...
                if ("string" == typeof b) b = e(b);
                    ...
                    b = {};
                    d = f.attributes;
                    b[f.element] = f = { styles: f.styles, requiredStyles: f.styles && CKEDITOR.tools.object.keys(f.styles) };
                ...
                } else if (CKEDITOR.tools.isArray(b)) { for (f = 0; f < b.length; ++f) n = this.allow(b[f], c, d); return n }
            ...
            applyTo: function(a, b, c, d) {
                        ...
                        a: {
                            ...
                            if (n)
                                for (h = 0; h < n.length; ++h)
                                    if ((q = d.match(n[h])) && q[0].length == d.length) {
                                        c = !0;
                                        break a
                                    }
                ...
                var h;
                a = [];
                d = x[d || (this.editor ? this.editor.enterMode : CKEDITOR.ENTER_P)];
                for (var g; c = e.pop();) c.type == CKEDITOR.NODE_ELEMENT ? H(c, d, a) : c.remove();
                for (; h = a.pop();)
                    if (c = h.el, c.parent) switch (g = q[c.parent.name] || q.span, h.check) {
                        case "it":
                            q.$removeEmpty[c.name] && !c.children.length ? H(c, d, a) : m(c) || H(c, d, a);
                            break;
                        case "el-up":
                            c.parent.type ==
                                CKEDITOR.NODE_DOCUMENT_FRAGMENT || g[c.name] || H(c, d, a);
                            break;
                        case "parent-down":
                            c.parent.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || g[c.name] || H(c.parent, d, a)
                    }
                return r
            },
                ...
                if (!this.disabled && a) {
                    ...
                    for (f = 0; f < a.length; ++f) {
                        ...
                        var e = void 0,
                            ...
                            h = void 0;
                        c = [];
                        for (n = 0; n < b.length; ++n) p = b[n], "string" == typeof p ? (p = p.split(/\s*:\s*/), r = p[0], m = null, h = p[1]) : (r = p.check, m = p.left, h = p.right), e || (e = p, e = e.element ? e.element : r ? r.match(/^([a-z0-9]+)/i)[0] :
                            e.left.getDefinition().element), m instanceof CKEDITOR.style && (m = B(m)), c.push({ check: r == e ? null : r, left: m, right: "string" == typeof h ? N(h) : h });
                        b = e;
                        d[b] || (d[b] = []);
                        d[b].push(c)
                    }
            ...
            check: function(a, b, c) {
                ...
                var f, p;
                if ("string" == typeof a) {
                    p = a + "\x3c" + (!1 === b ? "0" : "1") + (c ? "1" : "0") + "\x3e";
                    if (p in this._.cachedChecks) return this._.cachedChecks[p];
                    f = e(a).$1;
                    var r = f.styles,
                        d = f.classes;
                    f.name = f.elements;
                    ...
                    r && (f.attributes.style = CKEDITOR.tools.writeCssText(f.styles))
                } else f = a.getDefinition(), r = f.styles, d = f.attributes || {}, r && !CKEDITOR.tools.isEmpty(r) ? (r = D(r), d.style = CKEDITOR.tools.writeCssText(r, !0)) : r = {}, f = { name: f.element, attributes: d, classes: d["class"] ? d["class"].split(/\s+/) : [], styles: r, children: [] };
                var r = CKEDITOR.tools.clone(f),
                    m = [],
                    h;
                if (!1 !== b && (h = this._.transformations[f.name])) {
                    for (d =
                        0; d < h.length; ++d) n(this, f, h[d]);
                    u(f)
                }
                A(this, r, m, { doFilter: !0, doTransform: !1 !== b, skipRequired: !c, skipFinalValidation: !c });
                0 < m.length ? c = !1 : ((b = f.attributes["class"]) && (f.attributes["class"] = f.attributes["class"].split(" ").sort().join(" ")), c = CKEDITOR.tools.objectCompare(f.attributes, r.attributes, !0), b && (f.attributes["class"] = b));
                "string" == typeof a && (this._.cachedChecks[p] = c);
                return c
            },
        ...
        J = CKEDITOR.filter.transformationsTools = {
            ...
            alignmentToStyle: function(a) {
                if (!("float" in
                        a.styles)) { var b = a.attributes.align; if ("left" == b || "right" == b) a.styles["float"] = b }
            ...
            transform: function(a, b) {
                if ("string" == typeof b) a.name = b;
                    ...
                    for (e in f)
                        if ("class" ==
                            e)
                            for (c = a.classes.join("|"), p = f[e].split(/\s+/); r = p.pop();) - 1 == c.indexOf(r) && a.classes.push(r);
        ...
        return {
            load: function(b, c, f, h) {
                ...
                var g = b.length,
                    ...
                    v = [],
                    e = [],
                    z = function(a) { c && (k ? c.call(f, a) : c.call(f, v, e)) };
                if (0 === l) z(!0);
                else {
                    var w = function(a, b) {
                            (b ? v : e).push(a);
                            0 >= --l && (h && CKEDITOR.document.getDocumentElement().removeStyle("cursor"), z(b))
                        },
                        A = function(b, c) {
                            a[b] = 1;
                            var f = d[b];
                        ...
                        F = function(b) {
                            if (a[b]) w(b, !0);
                                ...
                                if (!(1 < f.length)) {
                                    ...
                                    c && (CKEDITOR.env.ie && (8 >= CKEDITOR.env.version || CKEDITOR.env.ie9Compat) ? e.$.onreadystatechange = function() { if ("loaded" == e.$.readyState || "complete" == e.$.readyState) e.$.onreadystatechange = null, A(b, !0) } : (e.$.onload = function() {
                                        setTimeout(function() {
                                            e.$.onload = null;
                                            e.$.onerror = null;
                                            A(b, !0)
        ...
        load: function(a, d, b) {
            ...
            CKEDITOR.scriptLoader.load(h,
                function(a, f) {
                    ...
                    for (var e = 0; e < a.length; e++)
                        for (var h = k[a[e]], l = 0; l < h.length; l++) {
                            var m = h[l];
                            g[m] = this.get(m);
                            c[m] = 1
                        }
                ...
                k = function(b) {
                    a.call(this, b, function(a) {
                        ...
                        for (e in a) {
                            ...
                            if (!d[e]) {
                                if (g.icons)
                                    for (var A = g.icons.split(","), F = A.length; F--;) CKEDITOR.skin.addIcon(A[F], g.path + "icons/" + (CKEDITOR.env.hidpi && g.hidpi ? "hidpi/" : "") + A[F] + ".png");
                                g.isSupportedEnvironment = g.isSupportedEnvironment || function() { return !0 };
                                d[e] = 1
                            }
                            if (w)
                                for (w.split && (w =
    ...
    (function() {
        function a(a, f, e) {
            ...
            CKEDITOR.fire("instanceCreated",
                null, this);
            CKEDITOR.add(this);
            CKEDITOR.tools.setTimeout(function() { this.isDestroyed() || this.isDetached() || g(this, a) }, 0, this)
        }

        function d() { do var a = "editor" + ++F; while (CKEDITOR.instances[a]); return a }
        ...
        function h(a, b, c) { if (b) { var d, f, e = a.commands; for (f in e) d = e[f], (c || d.contextSensitive) && d.refresh(a, b) } }
        ...
        function l(a) { CKEDITOR.skin.loadPart("editor", function() { v(a) }) }
            ...
            CKEDITOR.plugins.load(d.split(","),
                function(b) {
                    ...
                    for (var n in b) {
                        ...
                        if (t && (P = t.match(g)))
                            for (; t = P.pop();) CKEDITOR.error("editor-plugin-required", { plugin: t.replace(",", ""), requiredBy: n });
                        k && !a.lang[n] && (k.split && (k = k.split(",")), 0 <= CKEDITOR.tools.indexOf(k, a.langCode) ? C = a.langCode : (C = a.langCode.replace(/-.*/, ""), C = C != a.langCode && 0 <= CKEDITOR.tools.indexOf(k, C) ? C : 0 <= CKEDITOR.tools.indexOf(k,
                            "en") ? "en" : k[0]), h.langEntries && h.langEntries[C] ? (a.lang[n] = h.langEntries[C], C = null) : e.push(CKEDITOR.getUrl(h.path + "lang/" + C + ".js")));
                        f.push(C);
                        d.push(h)
                    }
                        ...
                        if (!a.isDestroyed() && !a.isDetached()) {
                            for (var b = ["beforeInit", "init", "afterInit"], e = 0; e < b.length; e++)
                                for (var n = 0; n < d.length; n++) {
                                    var r = d[n];
                                    0 === e && f[n] && r.lang && r.langEntries && (a.lang[r.name] = r.langEntries[f[n]]);
                                    if (r[b[e]]) r[b[e]](a)
                                }
        ...
        function A(a, b) {
            ...
            for (var f = new CKEDITOR.dom.documentFragment, e, h, g, k = 0; k < a.length; k++) {
                ...
                c(l) ? (e || (e = q.getAscendant("table").clone(), e.append(q.getAscendant({ thead: 1, tbody: 1, tfoot: 1 }).clone()), f.append(e), e = e.findOne("thead, tbody, tfoot")), h && h.equals(q) || (h = q, g = q.clone(), e.append(g)), g.append(d(l))) :
        ...
        CKEDITOR.tools.extend(CKEDITOR.editor.prototype, {
            plugins: { detectConflict: function(a, b) { for (var c = 0; c < b.length; c++) { var d = b[c]; if (this[d]) return CKEDITOR.warn("editor-plugin-conflict", { plugin: a, replacedWith: d }), !0 } return !1 } },
        ...
        CKEDITOR.htmlParser.fragment.fromHtml =
            function(h, k, g) {
                function l(a) {
                    ...
                    if (0 < m.length)
                        for (var c = 0; c < m.length; c++) {
                            ...
                            h && !h[f] || a && e && !e[a] && CKEDITOR.dtd[a] ? f == y.name && (z(y, y.parent, 1), c--) : (b || (v(), b = 1), d = d.clone(), d.parent = y, y = d, m.splice(c, 1), c--)
                        }
                }

                function v() { for (; M.length;) z(M.shift(), y) }
                ...
                function z(b, c, d) {
                    c = c || y || u;
                    var f = y;
                    void 0 === b.previous && (w(c, b) && (y = c, F.onTagOpen(g, {}), b.returnPoint = c = y), e(b), a(b) && !b.children.length || c.add(b), "pre" == b.name && (H = !1), "textarea" == b.name && (G = !1));
                ...
                F.onTagOpen = function(f, e, h, g) {
                    ...
                    if (a(e)) m.push(e);
                        ...
                        if ("pre" == f) H = !0;
                        else { if ("br" == f && H) { y.add(new CKEDITOR.htmlParser.text("\n")); return } "textarea" == f && (G = !0) }
                        if ("br" == f) M.push(e);
                        else {
                            for (; !(g = (h = y.name) ? CKEDITOR.dtd[h] || (y._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : c, e.isUnknown || y.isUnknown || g[f]);)
                                if (y.isOptionalClose) F.onTagClose(h);
                                else if (f in b && h in b) h = y.children, (h = h[h.length - 1]) && "li" == h.name || z(h = new CKEDITOR.htmlParser.element("li"), y), !e.returnPoint && (e.returnPoint = y), y = h;
                            else if (f in CKEDITOR.dtd.$listItem &&
                                !A(f, h)) F.onTagOpen("li" == f ? "ul" : "dl", {}, 0, 1);
                            else if (h in d && !A(f, h)) !e.returnPoint && (e.returnPoint = y), y = y.parent;
                            else if (h in CKEDITOR.dtd.$inline && m.unshift(y), y.parent) z(y, y.parent, 1);
                ...
                F.onTagClose = function(a) {
                    ...
                    for (var c = [], d = [], f = y; f != u && f.name != a;) f._.isBlockLike || d.unshift(f), c.push(f), f = f.returnPoint || f.parent;
                    if (f != u) {
                ...
                F.onText = function(a) {
                    if (!(y._.hasInlineStarted && !M.length || H || G) && (a = CKEDITOR.tools.ltrim(a), 0 === a.length)) return;
                    var b = y.name,
                        e = b ? CKEDITOR.dtd[b] || (y._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : c;
                    if (!G && !e["#"] && b in d) F.onTagOpen(f[b] || ""), F.onText(a);
                    else {
                        v();
                        l();
                        H || G || (a = a.replace(/[\t\r\n ]{2,}|[\t\r\n]/g, " "));
                        a = new CKEDITOR.htmlParser.text(a);
                        if (w(y, a)) this.onTagOpen(g, {}, 0, 1);
                        y.add(a)
                    }
                };
                F.onCDATA =
    ...
    (function() {
        ...
        CKEDITOR.htmlParser.filter = CKEDITOR.tools.createClass({
            ...
            proto: {
                ...
                onNode: function(a, c) { var d = c.type; return d == CKEDITOR.NODE_ELEMENT ? this.onElement(a, c) : d == CKEDITOR.NODE_TEXT ? new CKEDITOR.htmlParser.text(this.onText(a, c.value, c)) : d == CKEDITOR.NODE_COMMENT ? new CKEDITOR.htmlParser.comment(this.onComment(a, c.value, c)) : null },
        ...
        a.prototype = {
            ...
            addMany: function(a,
                c, d) {
                for (var h = [this.findIndex(c), 0], k = 0, g = a.length; k < g; k++) h.push({ value: a[k], priority: c, options: d });
            ...
            exec: function(a, c) {
                var d = c instanceof CKEDITOR.htmlParser.node || c instanceof CKEDITOR.htmlParser.fragment,
                    ...
                    l, v, e, z;
                for (z = 0; z < g; z++)
                    if (d && (l = c.type, v = c.name), e = k[z], !(a.nonEditable && !e.options.applyToAll ||
    ...
    (function() {
        function a(a, d) {
                ...
                return function(f) {
                    if (f.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
                        var p = [],
                            ...
                            n, q;
                        if (r)
                            for (t(r, 1) && p.push(r); r;) h(r) && (n = c(r)) && t(n) && ((q = c(n)) && !h(q) ? p.push(n) : (e(g).insertAfter(n), n.remove())), r = r.previous;
                        for (r = 0; r < p.length; r++) p[r].remove();
                        if (p = !a || !1 !== ("function" == typeof d ? d(f) : d)) g || CKEDITOR.env.needsBrFiller ||
                            f.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT ? g || CKEDITOR.env.needsBrFiller || !(7 < document.documentMode || f.name in CKEDITOR.dtd.tr || f.name in CKEDITOR.dtd.$listItem) ? (p = b(f), p = !p || "form" == f.name && "input" == p.name) : p = !1 : p = !1;
                        p && f.add(e(a))
                    }
                }
            }
            ...
            var q = { elements: {} },
                g = "html" == d,
                x = CKEDITOR.tools.extend({}, n),
                D;
            for (D in x) "#" in G[D] || delete x[D];
            for (D in x) q.elements[D] = r(g, a.config.fillEmptyBlocks);
            q.root = r(g, !1);
                    ...
                    if (b.parent.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
                        ...
                        if ("data-cke-bogus" in d || "data-cke-eol" in d) delete d["data-cke-bogus"];
                            ...
                            for (d = b.next; d && f(d);) d =
                                d.next;
                            var p = c(b);
                            !d && h(b.parent) ? k(b.parent, e(a)) : h(d) && p && !h(p) && e(a).insertBefore(d)
                        }
                    }
                }
            }(g);
        ...
        function z(a) { return a.replace(S, function(a, b) { return decodeURIComponent(b) }) }
        ...
        function F(a, b) { var c = b._.dataStore; return a.replace(/\x3c!--\{cke_protected\}([\s\S]+?)--\x3e/g, function(a, b) { return decodeURIComponent(b) }).replace(/\{cke_protected_(\d+)\}/g, function(a, b) { return c && c[b] || "" }) }
        ...
        function u(a, b) {
            ...
            for (var r = 0; r < d.length; r++) a = a.replace(d[r], function(a) { a = a.replace(e, function(a, b, d) { return c[d] }); return /cke_temp(comment)?/.test(a) ? a : "\x3c!--{cke_temp}" + (c.push(a) - 1) + "--\x3e" });
            ...
            return a = a.replace(/<(title|iframe|textarea)([^>]*)>([\s\S]*?)<\/\1>/g, function(a, c, d, f) { return "\x3c" + c + d + "\x3e" + F(A(f), b) + "\x3c/" + c + "\x3e" })
        }
        var m;
        CKEDITOR.htmlDataProcessor = function(b) {
            ...
            b.on("toHtml", function(a) {
                ...
                var r;
                CKEDITOR.env.ie && 9 > CKEDITOR.env.version && "pre" == f && (f = "div", c = "\x3cpre\x3e" + c + "\x3c/pre\x3e", r = 1);
                f = b.document.createElement(f);
                f.setHtml("a" + c);
                c = f.getHtml().substr(1);
                c = c.replace(new RegExp("data-cke-" + CKEDITOR.rnd + "-", "ig"), "");
                r && (c = c.replace(/^<pre>|<\/pre>$/gi, ""));
                c = c.replace(P, "$1$2");
                c = z(c);
                c = A(c);
                f = !1 === a.fixForBody ? !1 :
                ...
                f && (r = c, !r.children.length && CKEDITOR.dtd[r.name][f] && (f = new CKEDITOR.htmlParser.element(f), r.add(f)));
                a.dataValue = c
            }, null, null, 5);
            ...
            b.on("toHtml", function(a) { a.data.dataValue.filterChildren(r.dataFilter, !0) }, null, null, 10);
            b.on("toHtml", function(a) {
                a = a.data;
                var b = a.dataValue,
            ...
            b.on("toDataFormat", function(a) { a.data.dataValue.filterChildren(r.htmlFilter, !0) }, null, null, 10);
            b.on("toDataFormat", function(a) {
        ...
        CKEDITOR.htmlDataProcessor.prototype = {
            toHtml: function(a, b, c, d) {
                var f = this.editor,
                    e, r, n, h;
                b && "object" == typeof b ? (e = b.context, c = b.fixForBody, d = b.dontFilter, r = b.filter, n = b.enterMode, h = b.protectedWhitespaces) : e = b;
        ...
        var M = /(?:&nbsp;|\xa0)$/,
            ...
            n = CKEDITOR.tools.extend({}, G.$blockLimit,
                G.$block),
            C = { elements: { input: g, textarea: g } },
            L = {
                attributeNames: [
                    [/^on/, "data-cke-pa-on"],
        ...
        m = function() {
            ...
            function b(a) {
                ...
                c = a.charCodeAt(0);
                var d = c.toString(16);
                c = { htmlCode: "\x26#" + c + ";?", hex: "\x26#x0*" + d + ";?", entity: { "\x3c": "\x26lt;", "\x3e": "\x26gt;", ":": "\x26colon;" }[a] };
            ...
            return function(a) { return a.replace(c, "").replace(d, "") }
        }()
    })();
    "use strict";
    ...
    (function() {
        var a = /{([^}]+)}/g;
        CKEDITOR.template = function(a) { this.source = "function" === typeof a ? a : String(a) };
        CKEDITOR.template.prototype.output = function(d, b) { var c = ("function" === typeof this.source ? this.source(d) : this.source).replace(a, function(a, b) { return void 0 !== d[b] ? d[b] : a }); return b ? b.push(c) : c }
    })();
    delete CKEDITOR.loadFullCore;
    CKEDITOR.instances = {};
    CKEDITOR.document = new CKEDITOR.dom.document(document);
    CKEDITOR.add = function(a) {
        function d() { CKEDITOR.currentInstance == a && (CKEDITOR.currentInstance = null, CKEDITOR.fire("currentInstance")) }
    ...
    (function() {
        ...
        CKEDITOR.inlineAll = function() {
            ...
            for (b in CKEDITOR.dtd.$editable)
                for (var c = CKEDITOR.document.getElementsByTag(b), f = 0, h = c.count(); f < h; f++) a = c.getItem(f), "true" != a.getAttribute("contenteditable") || a.getEditor() || (d = { element: a, config: {} }, !1 !== CKEDITOR.fire("inline", d) && CKEDITOR.inline(a, d.config))
        };
    ...
    (function() {
        ...
        CKEDITOR.editor.prototype.setMode = function(a, b) {
            ...
            if (a != d.mode && k && k[a]) {
                ...
                this._.modes[a](function() {
                    ...
                    setTimeout(function() { d.isDestroyed() || d.isDetached() || (d.fire("mode"), b && b.call(d)) }, 0)
                })
            }
        };
        CKEDITOR.editor.prototype.resize = function(a, b, d, k) {
            ...
            b = d ? b + e : b;
            l.setStyle("height", CKEDITOR.tools.cssLength(g));
            v && (v.style.width = "100%");
    ...
    (function() {
        function a(a) {
            ...
            k(b, e.block, f) && q.collapsed && !q.getCommonAncestor().isReadOnly() && (e = q.clone(), e.enlarge(CKEDITOR.ENLARGE_BLOCK_CONTENTS), f = new CKEDITOR.dom.walker(e), f.guard = function(a) { return !c(a) || a.type == CKEDITOR.NODE_COMMENT || a.isReadOnly() }, !f.checkForward() || e.checkStartOfBlock() && e.checkEndOfBlock()) && (b = q.fixBlock(!0, b.activeEnterMode == CKEDITOR.ENTER_DIV ? "div" : "p"), CKEDITOR.env.needsBrFiller || (b = b.getFirst(c)) && b.type == CKEDITOR.NODE_TEXT && CKEDITOR.tools.trim(b.getText()).match(/^(?:&nbsp;|\xa0)$/) && b.remove(), h = 1, a.cancel());
            h && q.select()
        }
        ...
        function l(a) { a && a.isEmptyInlineRemoveable() && a.remove() }
        ...
        CKEDITOR.editable = CKEDITOR.tools.createClass({
            ...
            proto: {
                ...
                insertElementIntoRange: function(a, b) {
                    ...
                    b.deleteContents(1);
                    b.startContainer.type == CKEDITOR.NODE_ELEMENT && (b.startContainer.is({ tr: 1, table: 1, tbody: 1, thead: 1, tfoot: 1 }) ? M(b) : b.startContainer.is(CKEDITOR.dtd.$list) && y(b));
                    var g, r;
                    if (f)
                        for (;
                            (g = b.getCommonAncestor(0, 1)) && (r = CKEDITOR.dtd[g.getName()]) && (!r || !r[e]);)
                            if (g.getName() in
                                CKEDITOR.dtd.span) {
                ...
                detach: function() {
                    ...
                    this.clearListeners();
                    try { this._.cleanCustomData() } catch (a) { if (!CKEDITOR.env.ie || -2146828218 !== a.number) throw a; }
                ...
                fixInitialSelection: function() {
                    function a() {
                        ...
                        a: if (d.anchorNode && d.anchorNode == c.$) e = !0;
                                ...
                                if (CKEDITOR.env.webkit && (e = c.getDocument().getActive()) && e.equals(c) && !d.anchorNode) { e = !0; break a }
                                e = void 0
                            }
                ...
                setup: function() {
                    ...
                    this.attachListener(a, "beforeGetData", function() {
                        var b =
                            this.getData();
                        this.is("textarea") || !1 !== a.config.ignoreEmptyParagraph && (b = b.replace(u, function(a, b) { return b }));
                        a.setData(b, null, 1)
                    }, this);
                    ...
                    if (!this.is("textarea")) {
                        ...
                        if (k) {
                            ...
                            q ? k != q.getText() && (CKEDITOR.env.ie && 9 > CKEDITOR.env.version ? q.$.styleSheet.cssText = k : q.setText(k)) : (k = f.appendStyleText(k), k = new CKEDITOR.dom.element(k.ownerNode || k.owningElement), g.setCustomData("stylesheet", k), k.data("cke-temp", 1))
                        }
                        ...
                        a.blockless && CKEDITOR.env.ie && CKEDITOR.env.needsBrFiller &&
                            this.attachListener(this, "keyup", function(b) { b.data.getKeystroke() in D && !this.getFirst(c) && (this.appendBogus(), b = a.createRange(), b.moveToPosition(this, CKEDITOR.POSITION_AFTER_START), b.select()) });
                        ...
                        CKEDITOR.env.webkit && this.attachListener(a, "key", function(b) {
                            ...
                            if (c in D && (b = a.getSelection(), 0 !== b.getRanges().length)) {
                                ...
                                if (d.collapsed) a: {
                                    ...
                                    if (f && d[c ? "checkStartOfBlock" : "checkEndOfBlock"]() && d.moveToClosestEditablePosition(f, !c) && d.collapsed) {
                                        if (d.startContainer.type == CKEDITOR.NODE_ELEMENT) {
                                            var t = d.startContainer.getChild(d.startOffset - (c ? 1 : 0));
                                            if (t && t.type == CKEDITOR.NODE_ELEMENT && t.is("hr")) {
                                                a.fire("saveSnapshot");
                                                t.remove();
                                                b = !0;
                                                break a
                                ...
                                else c = d, q = b.block, d = c.endPath().block, q && d && !q.equals(d) ? (a.fire("saveSnapshot"), (f = q.getBogus()) && f.remove(), c.enlarge(CKEDITOR.ENLARGE_INLINE), c.deleteContents(), d.getParent() && (d.moveChildren(q, !1), b.lastElement.mergeSiblings(), e(q, d, !0)), c = a.getSelection().getRanges()[0], c.collapse(1), c.optimize(), "" === c.startContainer.getHtml() && c.startContainer.appendBogus(), c.select(), b = !0) : b = !1;
                                if (!b) return;
        ...
        m = function() {
            ...
            function f(b) { return b && a(b) && (b.is(r.$removeEmpty) || b.is("a") && !b.isBlockBoundary()) }

            function q(b, c, d, e) {
                var f = b.clone(),
                    g, r;
                f.setEndAt(c, CKEDITOR.POSITION_BEFORE_END);
                (g = (new CKEDITOR.dom.walker(f)).next()) && a(g) && x[g.getName()] &&
            ...
            var r = CKEDITOR.dtd,
                ...
                v = CKEDITOR.tools.extend({}, r.$inline);
            delete v.br;
            return function(t, x, I, p) {
                var J = t.editor,
                    E = !1;
                "unfiltered_html" == x && (x = "html", E = !0);
                if (!p.checkReadOnly()) {
                    var w = (new CKEDITOR.dom.elementPath(p.startContainer, p.root)).blockLimit || p.root;
                    x = { type: x, dontFilter: E, editable: t, editor: J, range: p, blockLimit: w, mergeCandidates: [], zombies: [] };
                    var E = x.range,
                        w = x.mergeCandidates,
                        K = "html" === x.type,
                        u, z, A, y, F, V;
                    "text" == x.type &&
                        E.shrink(CKEDITOR.SHRINK_ELEMENT, !0, !1) && (z = CKEDITOR.dom.element.createFromHtml("\x3cspan\x3e\x26nbsp;\x3c/span\x3e", E.document), E.insertNode(z), E.setStartAfter(z));
                    A = new CKEDITOR.dom.elementPath(E.startContainer);
                    x.endPath = y = new CKEDITOR.dom.elementPath(E.endContainer);
                    if (!E.collapsed) {
                        u = y.block || y.blockLimit;
                        var aa = E.getCommonAncestor();
                        u && !u.equals(aa) && !u.contains(aa) && E.checkEndOfBlock() && x.zombies.push(u);
                        E.deleteContents()
                    }
                    for (;
                        (F = e(E)) && a(F) && F.isBlockBoundary() && A.contains(F);) E.moveToPosition(F,
                        CKEDITOR.POSITION_BEFORE_END);
                    q(E, x.blockLimit, A, y);
                    z && (E.setEndBefore(z), E.collapse(), z.remove());
                    z = E.startPath();
                    if (u = z.contains(f, !1, 1)) V = E.splitElement(u), x.inlineStylesRoot = u, x.inlineStylesPeak = z.lastElement;
                    z = E.createBookmark();
                    K && (l(u), l(V));
                    (u = z.startNode.getPrevious(c)) && a(u) && f(u) && w.push(u);
                    (u = z.startNode.getNext(c)) && a(u) && f(u) && w.push(u);
                    for (u = z.startNode;
                        (u = u.getParent()) && f(u);) w.push(u);
                    E.moveToBookmark(z);
                    J.enterMode === CKEDITOR.ENTER_DIV && "" === J.getData(!0) && ((J = t.getFirst()) && J.remove(),
                        p.setStartAt(t, CKEDITOR.POSITION_AFTER_START), p.collapse(!0));
                    if (t = I) {
                        t = x.range;
                        if ("text" == x.type && x.inlineStylesRoot) {
                            p = x.inlineStylesPeak;
                            J = p.getDocument().createText("{cke-peak}");
                            for (V = x.inlineStylesRoot.getParent(); !p.equals(V);) J = J.appendTo(p.clone()), p = p.getParent();
                            I = J.getOuterHtml().split("{cke-peak}").join(I)
                        }
                        p = x.blockLimit.getName();
                        if (/^\s+|\s+$/.test(I) && "span" in CKEDITOR.dtd[p]) {
                            var W = '\x3cspan data-cke-marker\x3d"1"\x3e\x26nbsp;\x3c/span\x3e';
                            I = W + I + W
                        }
                        I = x.editor.dataProcessor.toHtml(I, { context: null, fixForBody: !1, protectedWhitespaces: !!W, dontFilter: x.dontFilter, filter: x.editor.activeFilter, enterMode: x.editor.activeEnterMode });
                        p = t.document.createElement("body");
                        p.setHtml(I);
                        W && (p.getFirst().remove(), p.getLast().remove());
                        if ((W = t.startPath().block) && (1 != W.getChildCount() || !W.getBogus())) a: {
                            var Q;
                            if (1 == p.getChildCount() && a(Q = p.getFirst()) && Q.is(m) && !Q.hasAttribute("contenteditable")) {
                                W = Q.getElementsByTag("*");
                                t = 0;
                                for (V = W.count(); t < V; t++)
                                    if (J = W.getItem(t), !J.is(v)) break a;
                    ...
                    if (t) {
                        ...
                        var R, W = [],
                            G, O;
                        I = z = 0;
                        var H, J = Q.startContainer;
                        F = x.endPath.elements[0];
                        var M, E = F.getPosition(J),
                            w = !!F.getCommonAncestor(J) && E != CKEDITOR.POSITION_IDENTICAL && !(E & CKEDITOR.POSITION_CONTAINS + CKEDITOR.POSITION_IS_CONTAINED),
                            J = b(x.dataWrapper, x);
                        for (h(J, Q); V < J.length; V++) {
                            E = J[V];
                            if (K = E.isLineBreak) K = Q, u = p, y = A = void 0, E.hasBlockSibling ? K = 1 : (A = K.startContainer.getAscendant(r.$block, 1)) && A.is({ div: 1, p: 1 }) ? (y = A.getPosition(u), y ==
                                CKEDITOR.POSITION_IDENTICAL || y == CKEDITOR.POSITION_CONTAINS ? K = 0 : (u = K.splitElement(A), K.moveToPosition(u, CKEDITOR.POSITION_AFTER_START), K = 1)) : K = 0;
                            if (K) I = 0 < V;
                            else {
                                K = Q.startPath();
                                !E.isBlock && k(x.editor, K.block, K.blockLimit) && (O = g(x.editor)) && (O = t.createElement(O), O.appendBogus(), Q.insertNode(O), CKEDITOR.env.needsBrFiller && (R = O.getBogus()) && R.remove(), Q.moveToPosition(O, CKEDITOR.POSITION_BEFORE_END));
                                if ((K = Q.startPath().block) && !K.equals(G)) {
                                    if (R = K.getBogus()) R.remove(), W.push(K);
                                    G = K
                                }
                                E.firstNotAllowed &&
                                    (z = 1);
                                if (z && E.isElement) {
                                    K = Q.startContainer;
                                    for (u = null; K && !r[K.getName()][E.name];) {
                                        if (K.equals(p)) { K = null; break }
                                        u = K;
                                        K = K.getParent()
                                    }
                                    if (K) u && (H = Q.splitElement(u), x.zombies.push(H), x.zombies.push(u));
                                    else {
                                        u = p.getName();
                                        M = !V;
                                        K = V == J.length - 1;
                                        ...
                                        A = [];
                                        y = u.length;
                                        for (var aa = 0, ca = void 0, Y = 0, X = -1; aa < y; aa++) ca = u[aa], " " == ca ? (Y || M && !aa || (A.push(new CKEDITOR.dom.text(" ")), X = A.length), Y = 1) : (A.push(ca), Y = 0);
                                        K && X == A.length && A.pop();
                                        M = A
                                    }
                                }
                                if (M) {
                                    for (; K = M.pop();) Q.insertNode(K);
                                    M = 0
                                } else Q.insertNode(E.node);
                                E.lastNotAllowed && V < J.length - 1 && ((H = w ? F : H) && Q.setEndAt(H, CKEDITOR.POSITION_AFTER_START), z = 0);
                                Q.collapse()
                            }
                        }
                        1 != J.length ? R = !1 : (R = J[0], R = R.isElement && "false" == R.node.getAttribute("contenteditable"));
                        R && (I = !0, K = J[0].node, Q.setStartAt(K, CKEDITOR.POSITION_BEFORE_START), Q.setEndAt(K, CKEDITOR.POSITION_AFTER_END));
                        x.dontMoveCaret = I;
                        x.bogusNeededBlocks = W
                    }
                    R = x.range;
                    var Z;
                    M = x.bogusNeededBlocks;
                    for (G = R.createBookmark(); O = x.zombies.pop();) O.getParent() && (H = R.clone(), H.moveToElementEditStart(O), H.removeEmptyBlocksAtEnd());
                    if (M)
                        for (; O = M.pop();) CKEDITOR.env.needsBrFiller ? O.appendBogus() : O.append(R.document.createText(" "));
                    for (; O = x.mergeCandidates.pop();) O.mergeSiblings();
                    ...
                    if (!x.dontMoveCaret) {
                        for (O = e(R); O && a(O) && !O.is(r.$empty);) {
                            if (O.isBlockBoundary()) R.moveToPosition(O, CKEDITOR.POSITION_BEFORE_END);
                                ...
                                if (f(O) && O.getHtml().match(/(\s|&nbsp;)$/g)) { Z = null; break }
                                Z = R.clone();
        ...
        M = function() {
            ...
            return function(d) {
                ...
                f || (f = e);
                f.is("table") ? (d.setStartAt(f, CKEDITOR.POSITION_BEFORE_START), d.collapse(!0), f.remove()) : (f.is({ tbody: 1, thead: 1, tfoot: 1 }) && (f = b(f, "tr", g)), f.is("tr") &&
        ...
        y = function() {
            function a(b) {
                ...
                b.evaluator = function(a) { return a.type == CKEDITOR.NODE_ELEMENT && a.is(CKEDITOR.dtd.$listItem) };
                return b
            }
            return function(b) {
            ...
            bogus: {
                exclude: function(a) {
                    var b = a.range.getBoundaryNodes(),
                        c = b.startNode,
                        b = b.endNode;
                    !b || !F(b) || c && c.equals(b) || a.range.setEndBefore(b)
                }
            },
            tree: {
                rebuild: function(a, b) {
                    ...
                    if (e.blockLimit.is({ tr: 1, table: 1 })) {
                        var r = e.contains("table").getParent();
                        g = function(a) { return !a.equals(r) }
                    } else if (e.block &&
        ...
        H = function() {
            ...
            return {
                    ...
                    function a(c) {
                        ...
                        g.guard = function(a,
                            ...
                            if (g && h && a.equals(h)) f = c.clone(), f.setEndAt(h, CKEDITOR.POSITION_BEFORE_END), e.push(f);
                                ...
                                if (l = !g) l = a.type == CKEDITOR.NODE_ELEMENT && a.is(d) && (!h || b(a, h)) && (!t || b(a, t));
                                if (!l && (l = g))
                                    if (a.is(d)) var l = h && h.getAscendant("table", !0),
                                        m = t && t.getAscendant("table", !0),
                                        n = a.getAscendant("table", !0),
                                        l = l && l.contains(n) || m && m.contains(n);
                                    else l = void 0;
                ...
                autoParagraph: function(a, b) {
                    var c = b.startPath(),
                        d;
                    k(a, c.block, c.blockLimit) && (d = g(a)) && (d = b.document.createElement(d), d.appendBogus(), b.insertNode(d), b.moveToPosition(d,
                        CKEDITOR.POSITION_AFTER_START))
                }
            }
        }()
    ...
    (function() {
            ...
            if (b) {
                ...
                if (!(e = !c) && (e = !c.isHidden())) {
                    ...
                    var f = c.getRanges(),
                        ...
                        t = g.length && g[0]._getTableElement() && g[0]._getTableElement().getAscendant("table", !0),
                    ...
                    if (a(e.getSelectedElement())) e = !1;
                        ...
                        var p = 1 === f.length && f[0].collapsed,
                            g = d(f, !!CKEDITOR.env.webkit) &&
                            d(g);
                        h = h && t ? h.equals(t) || t.contains(h) : !1;
                        h && (p || g) ? (k && !l && e.selectRanges(f), e = !0) : e = !1
                    }
                    e = !e
                }
                e && (b.reset(), b = 0)
        ...
        function k() {
            C = !0;
            n || (g.call(this), n = CKEDITOR.tools.setTimeout(g, 200, this))
        }

        function g() {
            n = null;
            C && (CKEDITOR.tools.setTimeout(h, 0, this), C = !1)
        }

        function l(a) { return L(a) || a.type == CKEDITOR.NODE_ELEMENT && !a.is(CKEDITOR.dtd.$empty) ? !0 : !1 }
        ...
        function w(a, b) { return b ? a.replace(G, function(a, b) { return b ? " " : "" }) : a.replace(y, "") }
        ...
        var m = "function" != typeof window.getSelection,
            ...
            G = new RegExp(y + "( )?", "g"),
            H, n, C, L = CKEDITOR.dom.walker.invisible(1),
            B = function() {
                function a(b) {
                    return function(a) {
                        var c =
        ...
        CKEDITOR.on("instanceCreated", function(a) {
            ...
            c.on("contentDom", function() {
                ...
                function d(a) {
                    ...
                    b || (b = this.getSelection(1), (c = e(b)) && !c.equals(p) && (b.selectElement(c), a.data.preventDefault()))
                }

                function e(a) { a = a.getRanges()[0]; return a ? (a = a.startContainer.getAscendant(function(a) { return a.type == CKEDITOR.NODE_ELEMENT && a.hasAttribute("contenteditable") }, !0)) && "false" === a.getAttribute("contenteditable") ? a : null : null }
                var f = c.document,
                    g = CKEDITOR.document,
                    p = c.editable(),
                    l = f.getBody(),
                    ...
                    D = p.isInline(),
                    n, v;
                CKEDITOR.env.gecko && p.attachListener(p, "focus", function(a) {
                    a.removeListener();
                    0 !== n && (a = c.getSelection().getNative()) && a.isCollapsed && a.anchorNode == p.$ && (a = c.createRange(), a.moveToElementEditStart(p), a.select())
                }, null, null, -2);
                p.attachListener(p, CKEDITOR.env.webkit || CKEDITOR.env.gecko ? "focusin" : "focus", function() {
                    if (n && (CKEDITOR.env.webkit || CKEDITOR.env.gecko)) {
                        n = c._.previousActive && c._.previousActive.equals(f.getActive());
                        var a = null != c._.previousScrollTop && c._.previousScrollTop != p.$.scrollTop;
                        CKEDITOR.env.webkit && n && a && (p.$.scrollTop = c._.previousScrollTop)
                    }
                    c.unlockSelection(n);
                    n = 0
                }, null, null, -1);
                p.attachListener(p, "mousedown", function() { n = 0 });
                if (CKEDITOR.env.ie || CKEDITOR.env.gecko || D) m ? p.attachListener(p, "beforedeactivate", a, null, null, -1) : p.attachListener(c, "selectionCheck", a, null, null, -1), p.attachListener(p, CKEDITOR.env.webkit || CKEDITOR.env.gecko ? "focusout" : "blur", function() {
                        var a = v && (v.isFake || 2 > v.getRanges().length);
                        CKEDITOR.env.gecko && !D && a || (c.lockSelection(v), n = 1)
                    }, null, null, -1),
                    p.attachListener(p, "mousedown", function() { n = 0 });
                if (CKEDITOR.env.ie && !D) {
                    var u;
                    p.attachListener(p, "mousedown", function(a) { 2 == a.data.$.button && ((a = c.document.getSelection()) && a.getType() != CKEDITOR.SELECTION_NONE || (u = c.window.getScrollPosition())) });
                    p.attachListener(p, "mouseup", function(a) {
                        2 == a.data.$.button && u && (c.document.$.documentElement.scrollLeft = u.x, c.document.$.documentElement.scrollTop = u.y);
                        u = null
                    });
                            ...
                            q.on("mousedown", function(a) {
                                function b(a) {
                                    ...
                                    if (w) {
                                        ...
                                        w.setEndPoint(0 > A.compareEndPoints("StartToStart", c) ? "EndToEnd" : "StartToStart", c);
                                        w.select()
                                    }
                                }
                                ...
                                if (a.getTarget().is("html") && a.$.y < q.$.clientHeight && a.$.x < q.$.clientWidth) {
                                    w = l.$.createTextRange();
                                    try { w.moveToPoint(a.$.clientX, a.$.clientY) } catch (d) {}
                                    A =
                                        w.duplicate();
                                    q.on("mousemove", b);
                                    g.on("mouseup", c);
                ...
                p.attachListener(p, "selectionchange", h, c);
                ...
                if (D && (CKEDITOR.env.webkit || CKEDITOR.env.gecko)) {
                    var y;
                    p.attachListener(p, "mousedown", function() { y = 1 });
                    p.attachListener(f.getDocumentElement(), "mouseup", function() {
                        y && k.call(c);
                        y = 0
                    })
                } else p.attachListener(CKEDITOR.env.ie ? p : f.getDocumentElement(), "mouseup", k, c);
                CKEDITOR.env.webkit && p.attachListener(f, "keydown", function(a) {
            ...
            c.on("key", function(a) { if ("wysiwyg" == c.mode) { var b = c.getSelection(); if (b.isFake) { var d = B[a.data.keyCode]; if (d) return d({ editor: c, selected: b.getSelectedElement(), selection: b, keyEvent: a }) } } })
        });
        if (CKEDITOR.env.webkit) CKEDITOR.on("instanceReady", function(a) {
            ...
            b.on("getSnapshot", function(a) { a.data && (a.data = w(a.data)) }, b, null, 20);
            b.on("toDataFormat", function(a) { a.data.dataValue = w(a.data.dataValue) }, null, null, 0)
        });
        ...
        CKEDITOR.editor.prototype.getSelectedRanges = function(a) { var b = this.getSelection(); return b && b.getRanges(a) || [] };
        ...
        CKEDITOR.tools.extend(CKEDITOR.dom.selection, { _removeFillingCharSequenceString: w, _createFillingCharSequenceNode: e, FILLING_CHAR_SEQUENCE: y });
        CKEDITOR.dom.selection.prototype = {
            getNative: function() { return void 0 !== this._.cache.nativeSel ? this._.cache.nativeSel : this._.cache.nativeSel = m ? this.document.$.selection : this.document.getWindow().$.getSelection() },
            getType: m ? function() {
                var a = this._.cache;
            ...
            getRanges: function() {
                var a = m ? function() {
                    ...
                    var b = function(b, c) {
                        ...
                        for (var e = d.children, f, g, h = b.duplicate(), k = 0, l = e.length - 1, m = -1, q, r; k <= l;)
                            if (m = Math.floor((k + l) / 2), f = e[m], h.moveToElementText(f), q = h.compareEndPoints("StartToStart", b), 0 < q) l = m - 1;
                            else if (0 > q) k = m + 1;
                        else return { container: d, offset: a(f) };
                        if (-1 == m || m == e.length - 1 && 0 > q) {
                            ...
                            for (d = e.length; 0 < h && 0 < d;) g = e[--d], g.nodeType == CKEDITOR.NODE_TEXT && (r = g, h -= g.nodeValue.length);
                        ...
                        for (; 0 < h;) try { g = f[0 < q ? "previousSibling" : "nextSibling"], g.nodeType == CKEDITOR.NODE_TEXT && (h -= g.nodeValue.length, r = g), f = g } catch (n) { return { container: d, offset: a(f) } }
                        return { container: r, offset: 0 < q ? -h : r.nodeValue.length + h }
                    };
                    return function() {
            ...
            unlock: function(a) {
                if (this.isLocked) {
                    ...
                    this.isLocked = 0;
                    this.reset();
                    a && (a = b || c[0] && c[0].getCommonAncestor()) && a.getAscendant("body", 1) && ((a = this.root.editor) && a.plugins.tableselection && a.plugins.tableselection.isSupportedEnvironment(a) && d(c) ? f.call(this, c) : e ? this.fake(b) : b && 2 > c.length ? this.selectElement(b) : this.selectRanges(c))
                }
            },
            reset: function() {
                this._.cache = {};
            ...
            selectRanges: function(a) {
                ...
                if (a.length)
                    if (this.isLocked) {
                        ...
                        a: {
                            var l, I;
                            if (1 == a.length && !(I = a[0]).collapsed && (t = I.getEnclosedNode()) && t.type == CKEDITOR.NODE_ELEMENT && (I = I.clone(), I.shrink(CKEDITOR.SHRINK_ELEMENT, !0), (l = I.getEnclosedNode()) && l.type == CKEDITOR.NODE_ELEMENT && (t = l), "false" == t.getAttribute("contenteditable"))) break a;
                            t = void 0
                        }
                        if (t) this.fake(t);
                        else if (b && b.plugins.tableselection && b.plugins.tableselection.isSupportedEnvironment(b) && d(a) && !H && !a[0]._getTableElement({ table: 1 }).hasAttribute("data-cke-tableselection-ignored")) f.call(this, a);
                        else {
                            if (m) {
                                ...
                                if ((c = b.getEnclosedNode()) && c.type == CKEDITOR.NODE_ELEMENT && c.getName() in N && (!c.is("a") ||
                                        !c.getText())) try {
                                    E = c.$.createControlRange();
                                    E.addElement(c.$);
                                    E.select();
                                    return
                                } catch (u) {}
                                if (b.startContainer.type == CKEDITOR.NODE_ELEMENT && b.startContainer.getName() in I || b.endContainer.type == CKEDITOR.NODE_ELEMENT && b.endContainer.getName() in I) b.shrink(CKEDITOR.NODE_ELEMENT, !0), a = b.collapsed;
                                E = b.createBookmark();
                                I = E.startNode;
                                a || (k = E.endNode);
                                E = b.document.$.body.createTextRange();
                                E.moveToElementText(I.$);
                                E.moveStart("character", 1);
                                k ? (t = b.document.$.body.createTextRange(), t.moveToElementText(k.$),
                                    E.setEndPoint("EndToEnd", t), E.moveEnd("character", -1)) : (p = I.getNext(l), n = I.hasAscendant("pre"), p = !(p && p.getText && p.getText().match(t)) && (n || !I.hasPrevious() || I.getPrevious().is && I.getPrevious().is("br")), n = b.document.createElement("span"), n.setHtml("\x26#65279;"), n.insertBefore(I), p && b.document.createText("﻿").insertBefore(I));
                                b.setStartBefore(I);
                                I.remove();
                                a ? (p ? (E.moveStart("character", -1), E.select(), b.document.$.selection.clear()) : E.select(), b.moveToPosition(n, CKEDITOR.POSITION_BEFORE_START), n.remove()) :
                                ...
                                for (E = 0; E < a.length; E++) {
                                    if (E < a.length - 1 && (p = a[E], n = a[E + 1], t = p.clone(), t.setStart(p.endContainer, p.endOffset), t.setEnd(n.startContainer, n.startOffset), !t.collapsed && (t.shrink(CKEDITOR.NODE_ELEMENT, !0), b = t.getCommonAncestor(), t = t.getEnclosedNode(), b.isReadOnly() || t && t.isReadOnly()))) {
                                        n.setStart(p.startContainer, p.startOffset);
                                        a.splice(E--, 1);
                                        continue
                                    }
                                    b = a[E];
                                    ...
                                    b.collapsed &&
                                        CKEDITOR.env.webkit && v(b) && (t = e(this.root), b.insertNode(t), (p = t.getNext()) && !t.getPrevious() && p.type == CKEDITOR.NODE_ELEMENT && "br" == p.getName() ? (z(this.root), b.moveToPosition(p, CKEDITOR.POSITION_BEFORE_START)) : b.moveToPosition(t, CKEDITOR.POSITION_AFTER_END));
                                    n.setStart(b.startContainer.$, b.startOffset);
                                    try { n.setEnd(b.endContainer.$, b.endOffset) } catch (w) {
                                        if (0 <= w.toString().indexOf("NS_ERROR_ILLEGAL_VALUE")) b.collapse(1), n.setEnd(b.endContainer.$, b.endOffset);
                                        else throw w;
                                    }
                                    k.addRange(n)
                                }
            ...
            removeAllRanges: function() {
                if (this.getType() != CKEDITOR.SELECTION_NONE) {
                    var a = this.getNative();
                    try { a && a[m ? "empty" : "removeAllRanges"]() } catch (b) {}
                    this.reset()
                }
            }
        }
    ...
    (function() {
        ...
        function b(c) {
            ...
            if (c.collapsed) e = M(this, e), c.insertNode(e), c.moveToPosition(e, CKEDITOR.POSITION_BEFORE_END);
                ...
                for (q.getPosition(w) == CKEDITOR.POSITION_FOLLOWING && (q = 0); q;) {
                    l = !1;
                    if (q.equals(w)) q = null, l = !0;
                    else {
                        var A = q.type == CKEDITOR.NODE_ELEMENT ? q.getName() : null,
                            x = A && "false" == q.getAttribute("contentEditable"),
                            y = A &&
                            -1 !== CKEDITOR.tools.array.indexOf(CKEDITOR.style.unstylableElements, A),
                            y = A && (q.getAttribute("data-nostyle") || y);
                        if (A && q.data("cke-bookmark") || q.type === CKEDITOR.NODE_COMMENT) { q = q.getNextSourceNode(!0); continue }
                        if (x && m && CKEDITOR.dtd.$block[A])
                            for (var B = q, C = f(B), D = void 0, G = C.length, H = 0, B = G && new CKEDITOR.dom.range(B.getDocument()); H < G; ++H) {
                                var D = C[H],
                                    L = CKEDITOR.filter.instances[D.data("cke-filter")];
                                if (L ? L.check(this) : 1) B.selectNodeContents(D), b.call(this, B)
                            }
                        C = A ? !n[A] || y ? 0 : x && !m ? 0 : d(q, w, h, T) : 1;
                        if (C)
                            if (D =
                                q.getParent(), C = h, G = g, H = k, !D || !(D.getDtd() || CKEDITOR.dtd.span)[G] && !H || C.parentRule && !C.parentRule(D)) l = !0;
                            else {
                                if (z || A && CKEDITOR.dtd.$removeEmpty[A] && (q.getPosition(w) | T) != T || (z = c.clone(), z.setStartBefore(q)), A = q.type, A == CKEDITOR.NODE_TEXT || x || A == CKEDITOR.NODE_ELEMENT && !q.getChildCount()) {
                                    for (var A = q, N;
                                        (l = !A.getNext(r)) && (N = A.getParent(), n[N.getName()]) && d(N, u, h, S);) A = N;
                                    z.setEndAfter(A)
                                }
                            }
                        else l = !0;
                        q = q.getNextSourceNode(y || x)
                    }
                    if (l && z && !z.collapsed) {
                        for (var l = M(this, e), x = l.hasAttributes(), y = z.getCommonAncestor(),
                                A = {}, C = {}, D = {}, G = {}, Y, X, Z; l && y;) {
                            if (y.getName() == g) { for (Y in h.attributes) !G[Y] && (Z = y.getAttribute(X)) && (l.getAttribute(Y) == Z ? C[Y] = 1 : G[Y] = 1); for (X in h.styles) !D[X] && (Z = y.getStyle(X)) && (l.getStyle(X) == Z ? A[X] = 1 : D[X] = 1) }
                            y = y.getParent()
                        }
                        for (Y in C) l.removeAttribute(Y);
                        for (X in A) l.removeStyle(X);
                        x && !l.hasAttributes() && (l = null);
                        l ? (z.extractContents().appendTo(l), z.insertNode(l), F.call(this, l), l.mergeSiblings(), CKEDITOR.env.ie || l.$.normalize()) : (l = new CKEDITOR.dom.element("span"), z.extractContents().appendTo(l),
                            z.insertNode(l), F.call(this, l), l.remove(!0));
                        z = null
                    }
                }
                c.moveToBookmark(v);
        ...
        function c(a) {
            ...
            if (a.collapsed) {
                ...
                var m = c.endNode,
                    n = this;
                b();
                for (f = d; !f.equals(m);) g = f.getNextSourceNode(), f.type == CKEDITOR.NODE_ELEMENT && this.checkElementRemovable(f) && (f.getName() == this.element ? A.call(this, f) : u(f, H(this)[f.getName()]), g.type == CKEDITOR.NODE_ELEMENT && g.contains(d) &&
                    (b(), g = d.getNext())), f = g
            }
            a.moveToBookmark(c);
        ...
        function g(a) {
            ...
            for (var d, e = a.document, f; d = c.getNextParagraph();) !d.isReadOnly() && (c.activeFilter ? c.activeFilter.check(this) : 1) && (f = M(this, e, d), v(d, f));
            a.moveToBookmark(b)
        }
        ...
        function l(a) {
            ...
            for (var d, e; d = c.getNextParagraph();) this.checkElementRemovable(d) && (d.is("pre") ? ((e = this._.enterMode == CKEDITOR.ENTER_BR ? null : a.document.createElement(this._.enterMode == CKEDITOR.ENTER_P ? "p" : "div")) && d.copyAttributes(e), v(d, e)) : A.call(this, d));
            a.moveToBookmark(b)
        }
        ...
        function A(a, b) {
            ...
            for (var h in c) this._.definition.fullMatch && a.getStyle(h) != n(h, c[h], !0) || (f = f || !!a.getStyle(h), a.removeStyle(h));
            u(a, e, B[a.getName()]);
        ...
        function F(a) {
            for (var b = H(this), c = a.getElementsByTag(this.element), d, e = c.count(); 0 <= --e;) d = c.getItem(e), d.isReadOnly() || A.call(this, d, !0);
            for (var f in b)
                if (f != this.element)
        ...
        function G(a, b) { for (var c in a) a[c] = a[c].replace(D, function(a, c) { return b[c] }) }
        ...
        var B = { address: 1, div: 1, h1: 1, h2: 1, h3: 1, h4: 1, h5: 1, h6: 1, p: 1, pre: 1, section: 1, header: 1, footer: 1, nav: 1, article: 1, aside: 1, figure: 1, dialog: 1, hgroup: 1, time: 1, meter: 1, menu: 1, command: 1, keygen: 1, output: 1, progress: 1, details: 1, datagrid: 1, datalist: 1 },
            N = {
                a: 1,
                blockquote: 1,
                embed: 1,
            ...
            q = /\s*(?:;\s*|$)/,
            D = /#\((.+?)\)/g,
            r = CKEDITOR.dom.walker.bookmark(0, 1),
        ...
        CKEDITOR.style = function(a, b) {
            ...
            b && (a = CKEDITOR.tools.clone(a), G(a.attributes, b), G(a.styles, b));
            c = this.element = a.element ? "string" == typeof a.element ? a.element.toLowerCase() :
                a.element : "*";
            this.type = a.type || (B[c] ? CKEDITOR.STYLE_BLOCK : N[c] ? CKEDITOR.STYLE_OBJECT : CKEDITOR.STYLE_INLINE);
            ...
            checkElementMatch: function(a, b) {
                ...
                if ("string" == typeof this.element ?
                    ...
                    if (c._length) {
                        for (var h in c)
                            if ("_length" != h)
                                if (d = a.getAttribute(h) || "", "style" == h ? C(c[h], d) : c[h] == d) { if (!b) return !0 } else if (b) return !1;
                        if (b) return !0
                    } else return !0
                }
                return !1
    ...
    (function() {
        if (window.Promise) CKEDITOR.tools.promise = Promise;
            ...
            if ("function" === typeof window.define && window.define.amd && "function" === typeof window.require) return window.require([a], function(a) { CKEDITOR.tools.promise = a });
            CKEDITOR.scriptLoader.load(a, function(d) { if (!d) return CKEDITOR.error("no-vendor-lib", { path: a }); if ("undefined" !== typeof window.ES6Promise) return CKEDITOR.tools.promise = ES6Promise })
        }
    })();
    (function() {
        function a(a, f, h) {
        ...
        CKEDITOR.dom.selection.setupEditorOptimization = function(a) {
            ...
            a.on("contentDom", function() {
                var b = a.editable();
                b && (b.attachListener(b, "keydown", function(a) { this._.shiftPressed = a.data.$.shiftKey }, this), b.attachListener(b, "keyup", function(a) {
                    this._.shiftPressed =
                        a.data.$.shiftKey
                }, this))
            })
        ...
        CKEDITOR.dom.selection.prototype.optimizeInElementEnds = function() {
            ...
            h && (h = b.clone(), b.shrink(CKEDITOR.SHRINK_TEXT, !1, { skipBogus: !CKEDITOR.env.webkit }), d = !1, a(f, b, h), b.select(), d = !0)
        }
    })();
                ...
                if (l.type == CKEDITOR.NODE_ELEMENT) {
                    ...
                    if (!k && (v = l.getName(),
                        ...
                        if (v = !h && "div" == v) {
                            a: {
                                v = l.getChildren();
                                for (var e = 0, z = v.count(); e < z; e++) { var w = v.getItem(e); if (w.type == CKEDITOR.NODE_ELEMENT && CKEDITOR.dtd.$block[w.getName()]) { v = !0; break a } }
                                v = !1
                            }
                            v = !v
                        }
            ...
            if (!CKEDITOR.env.ie || !CKEDITOR.env.quirks) {
                ...
                a = function(a) {
                    ...
                    if (!a.getById("cke_ui_color")) {
                        var d = c(a);
                        g.push(d);
                        b.on("destroy", function() { g = CKEDITOR.tools.array.filter(g, function(a) { return d !== a }) });
    ...
    */
    ...
    (function() {
        ...
        function K(a, b) { for (var c = a.$.getElementsByTagName("input"), e = 0, d = c.length; e < d; e++) { var f = new CKEDITOR.dom.element(c[e]); "text" == f.getAttribute("type").toLowerCase() && (b ? (f.setAttribute("value", f.getCustomData("fake_value") || ""), f.removeCustomData("fake_value")) : (f.setCustomData("fake_value", f.getAttribute("value")), f.setAttribute("value", ""))) } }
        ...
        function Z(a) {
            var b = CKEDITOR.dom.element.createFromHtml(CKEDITOR.addTemplate("dialog", aa).output({ id: CKEDITOR.tools.getNextNumber(), editorId: a.id, langDir: a.lang.dir, langCode: a.langCode, editorDialogClass: "cke_editor_" + a.name.replace(/\./g, "\\.") + "_dialog", closeTitle: a.lang.common.close, hidpi: CKEDITOR.env.hidpi ? "cke_hidpi" : "" })),
            ...
            if (d != CKEDITOR.DIALOG_RESIZE_NONE) {
                var f = a.getParentEditor(),
                    g, h, p, m, k, q, l = CKEDITOR.tools.addFunction(function(d) {
                        function e(a) { return a.isVisible() }
                        k = a.getSize();
        ...
        function H(a) { a.data.preventDefault(1) }
        ...
        function T(a, b, c, e, d) {
            (x[c] || (x[c] = [])).push({ uiElement: a, dialog: b, key: c, keyup: d || a.accessKeyUp, keydown: e || a.accessKeyDown })
        }
        ...
        function fa(a, b) { a._.accessKeyMap[b] && a.selectPage(a._.accessKeyMap[b]) }
        ...
        CKEDITOR.dialog = function(a, b) {
            ...
            function d(b) {
                if (n == CKEDITOR.dialog._.currentTop) {
                    ...
                    if (9 == c || c == CKEDITOR.SHIFT + 9) e(c == CKEDITOR.SHIFT + 9 ? -1 : 1), q = 1;
                        ...
                        else if (27 == c)(c = this.getButton("cancel")) ? CKEDITOR.tools.setTimeout(c.click, 0, c) : !1 !== this.fire("cancel", { hide: !0 }).hide && this.hide(), l = 1;
                    else return;
            ...
            function f(a) { q ? a.data.preventDefault(1) : l && a.data.stopPropagation() }
            ...
            CKEDITOR.event.call(this);
            this.definition = g = CKEDITOR.fire("dialogDefinition", { name: b, definition: g, dialog: this }, a).definition;
        ...
        CKEDITOR.dialog.prototype = {
            ...
            addPage: function(a) {
                if (!a.requiredContent || this._.editor.filter.check(a.requiredContent)) {
                    for (var b = [], c = a.label ? ' title\x3d"' + CKEDITOR.tools.htmlEncode(a.label) +
                            '"' : "", e = CKEDITOR.dialog._.uiElementBuilders.vbox.build(this, { type: "vbox", className: "cke_dialog_page_contents", children: a.elements, expand: !!a.expand, padding: a.padding, style: a.style || "width: 100%;" }, b), d = this._.contents[a.id] = {}, f = e.getChild(), g = 0; e = f.shift();) e.notAllowed || "hbox" == e.type || "vbox" == e.type || g++, d[e.id] = e, "function" == typeof e.getChild && f.push.apply(f, e.getChild());
                    g || (a.hidden = !0);
            ...
            setModel: function(a) { this._.model = a },
            getMode: function(a) {
        ...
        CKEDITOR.tools.extend(CKEDITOR.dialog, {
            ...
            okButton: function() {
                var a = function(a, c) { c = c || {}; return CKEDITOR.tools.extend({ id: "ok", type: "button", label: a.lang.common.ok, "class": "cke_dialog_ui_button_ok", onClick: function(a) { a = a.data.dialog;!1 !== a.fire("ok", { hide: !0 }).hide && a.hide() } }, c, !0) };
                a.type = "button";
        ...
        U = { resizable: CKEDITOR.DIALOG_RESIZE_BOTH, minWidth: 600, minHeight: 400, buttons: [CKEDITOR.dialog.okButton, CKEDITOR.dialog.cancelButton] };
        var E = function(a, b, c) {
            ...
            F = function(a, b, c, e, d) {
                if (c) { for (var f = 0, g; g = a[f]; f++) { if (g.id == c) return a.splice(f, 0, b), b; if (e && g[e] && (g = F(g[e], b, c, e, !0))) return g } if (d) return null }
                a.push(b);
                return b
            },
            G = function(a, b, c) {
        ...
        M.prototype = { getContents: function(a) { return E(this.contents, a) }, getButton: function(a) { return E(this.buttons, a) }, addContents: function(a, b) { return F(this.contents, a, b) }, addButton: function(a, b) { return F(this.buttons, a, b) }, removeContents: function(a) { G(this.contents, a) }, removeButton: function(a) { G(this.buttons, a) } };
        N.prototype = {
            get: function(a) { return E(this.elements, a, "children") },
            add: function(a, b) { return F(this.elements, a, b, "children") },
            remove: function(a) {
                G(this.elements, a,
                    "children")
            }
        ...
        CKEDITOR.dialogCommand.prototype = {
            exec: function(a) {
                var b = this.tabId;
                a.openDialog(this.dialogName, function(a) { b && a.selectPage(b) })
            },
            canUndo: !1,
            editorFocus: 1
        };
        ...
        CKEDITOR.tools.extend(CKEDITOR.editor.prototype, {
            openDialog: function(a, b, c) {
                ...
                if (e) e.once("hide", function() { e.setModel(null) }, null, null, 999);
                return e
            }
        });
        CKEDITOR.plugins.add("dialog", {
            ...
            init: function(a) {
                ...
                a.on("doubleclick", function(b) { b.data.dialog && a.openDialog(b.data.dialog) }, null, null, 999)
            }
        })
    })();
        ...
        CKEDITOR.ui.button.prototype = {
            render: function(a, b) {
                ...
                var p = null,
                    ...
                    k, l, m;
                this._.editor = a;
                var e = { id: r, button: this, editor: a, focus: function() { CKEDITOR.document.getById(r).focus() }, execute: function() { this.button.click(a) }, attach: function(a) { this.button.attach(a) } },
                ...
                this.modes ? (p = {}, a.on("beforeModeUnload", function() { a.mode && this._.state != CKEDITOR.TRISTATE_DISABLED && (p[a.mode] = this._.state) }, this), a.on("activeFilterChange", c, this), a.on("mode", c, this), !this.readOnly && a.on("readOnly", c, this)) : d && (d = a.getCommand(d)) && (d.on("state", function() { this.setState(d.state) }, this), g += d.state == CKEDITOR.TRISTATE_ON ?
    ...
    (function() {
        function r(a, b, c) {
            ...
            if (CKEDITOR.env.gecko && "drop" == b.method && a.toolbox) a.once("afterPaste", function() { a.toolbox.focus() });
        ...
        function x(a) {
            function b() {
                ...
                b.on(p.mainPasteEvent, function(a) { "beforepaste" == p.mainPasteEvent && n || k(a) });
                "beforepaste" == p.mainPasteEvent && (b.on("paste", function(a) { v || (f(), a.data.preventDefault(), k(a), e("paste")) }), b.on("contextmenu", h, null, null, 0), b.on("beforepaste", function(a) {!a.data || a.data.$.ctrlKey || a.data.$.shiftKey || h() }, null, null, 0));
                b.on("beforecut", function() {!n && g(a) });
                var d;
                b.attachListener(CKEDITOR.env.ie ?
                    b : a.document.getDocumentElement(), "mouseup",
                    function() { d = setTimeout(u, 0) });
            ...
            function l(b, c) {
                ...
                if (!d.getById("cke_pastebin")) {
                    ...
                    k.setStyles({ position: "absolute", top: d.getScrollPosition().y - h + 10 + "px", width: "1px", height: Math.max(1, d.getViewPaneSize().height - 20) + "px", overflow: "hidden", margin: 0, padding: 0 });
                    ...
                    var u = h.select();
                    CKEDITOR.env.ie && (m = e.once("blur", function() { a.lockSelection(u) }));
            ...
            function k(b) {
                ...
                e && p.canClipboardApiBeTrusted(c.dataTransfer, a) ? (b.data.preventDefault(), setTimeout(function() { r(a, c) }, 0)) : l(b, function(b) {
            ...
            function q(b) {
                var c = a.getSelection(),
                    c = c && c.getRanges()[0];
                if ((a.readOnly || c && c.checkReadOnly()) && b in { paste: 1, cut: 1 }) return CKEDITOR.TRISTATE_DISABLED;
            ...
            (function() {
                ...
                if (a.contextMenu) {
                    a.contextMenu.addListener(function() { return { cut: q("cut"), copy: q("copy"), paste: q("paste") } });
                    var c = null;
                ...
                if (a.ui.addButton) a.once("instanceReady",
                    function() {
                        a._.pasteButtons && CKEDITOR.tools.array.forEach(a._.pasteButtons, function(b) {
                            if (b = a.ui.get(b))
                                if (b = CKEDITOR.document.getById(b._.id)) b.on("touchend", function() { a._.forcePasteDialog = !0 })
                        })
                    })
            })();
            (function() {
        ...
        function B(a) {
            ...
            var c = {};
            return { get: function(d) { return "plain-text" == d ? c.plainText || (c.plainText = new CKEDITOR.filter(a, "br")) : "semantic-content" == d ? ((d = c.semanticContent) || (d = new CKEDITOR.filter(a, {}), d.allow({ $1: { elements: b(), attributes: !0, styles: !1, classes: !1 } }), d = c.semanticContent = d), d) : d ? new CKEDITOR.filter(a, d) : null } }
        }
        ...
        function A(a, b) { a.enterMode == CKEDITOR.ENTER_BR ? b = b.replace(/(<\/p><p>)+/g, function(a) { return CKEDITOR.tools.repeat("\x3cbr\x3e", a.length / 7 * 2) }).replace(/<\/?p>/g, "") : a.enterMode == CKEDITOR.ENTER_DIV && (b = b.replace(/<(\/)?p>/g, "\x3c$1div\x3e")); return b }
            ...
            init: function(a) {
                ...
                if (CKEDITOR.env.gecko) {
                    ...
                    a.on("paste", function(c) {
                        ...
                        if (!d.dataValue && "paste" == d.method && b(l) && (l = l.getFile(0), -1 != CKEDITOR.tools.indexOf(f, l.type))) {
                            ...
                            t.addEventListener("abort", function() { a.fire("paste", c.data) }, !1);
                            t.addEventListener("error", function() { a.fire("paste", c.data) }, !1);
                            t.readAsDataURL(l);
                            h = d.dataTransfer.id;
                            c.stop()
                        }
                ...
                a.on("paste", function(a) {
                    ...
                    CKEDITOR.env.ie ? b = b.replace(/^&nbsp;(?: |\r\n)?<(\w+)/g, function(b, d) { return d.toLowerCase() in c ? (a.data.preSniffing = "html", "\x3c" + d) : b }) : CKEDITOR.env.webkit ? b = b.replace(/<\/(\w+)><div><br><\/div>$/,
                        function(b, d) { return d in c ? (a.data.endsWithEOL = 1, "\x3c/" + d + "\x3e") : b }) : CKEDITOR.env.gecko && (b = b.replace(/(\s)<br>$/, "$1"));
                    a.data.dataValue = b
                }, null, null, 3);
                a.on("paste", function(b) {
                    b = b.data;
                ...
                a.on("paste", function(b) {
                    b = b.data;
                    b.dataValue && (a.insertHtml(b.dataValue, b.type, b.range), setTimeout(function() { a.fire("afterPaste") },
                        0))
                }, null, null, 1E3);
                    ...
                    if (document.body.createTextRange) {
                        ...
                        try {
                            for (var g = !1, l = 0; 20 > l && !g; l++) {
                                if (!g) try { c.moveToPoint(d, f - l), g = !0 } catch (n) {}
                                if (!g) try { c.moveToPoint(d, f + l), g = !0 } catch (m) {}
                            }
                            if (g) {
        ...
        CKEDITOR.plugins.clipboard.dataTransfer.prototype = {
            ...
            isEmpty: function() {
                ...
                CKEDITOR.tools.array.forEach(CKEDITOR.tools.object.keys(this._.data), function(b) { a[b] = 1 });
                if (this.$)
                    if (CKEDITOR.plugins.clipboard.isCustomDataTypesSupported) {
                        if (this.$.types)
            ...
            _getImageFromClipboard: function() { var a; try { if (this.$ && this.$.items && this.$.items[0] && (a = this.$.items[0].getAsFile()) && a.type) return a } catch (b) {} },
        ...
        CKEDITOR.plugins.clipboard.fallbackDataTransfer.prototype = {
            isRequired: function() {
                ...
                if (null === a._isCustomMimeTypeSupported)
                    if (b) { a._isCustomMimeTypeSupported = !1; if (CKEDITOR.env.edge && 17 <= CKEDITOR.env.version) return !0; try { b.setData("cke/mimetypetest", "cke test value"), a._isCustomMimeTypeSupported = "cke test value" === b.getData("cke/mimetypetest"), b.clearData("cke/mimetypetest") } catch (c) {} } else return !1;
            ...
            setData: function(a, b) {
                ...
                try { f.setData(a, d), c && (this._dataTransfer._.nativeHtmlCache = d) } catch (h) {
                    if (this._isUnsupportedMimeTypeError(h)) {
                        ...
                        e[a] = d;
                        try { d = this._applyDataComment(c, e), f.setData(this._customDataFallbackType, d), this._dataTransfer._.nativeHtmlCache = d } catch (g) { d = "" }
                    }
                }
                return d
            },
    ...
    (function() {
        ...
        function y(a) { a = a.getSelection().getRanges(!0); for (var e = a.length - 1; 0 < e; e--) a[e].deleteContents(); return a[0] }

        function z(a) {
            var e = a.startContainer.getAscendant(function(a) { return a.type == CKEDITOR.NODE_ELEMENT && "true" == a.getAttribute("contenteditable") }, !0);
        ...
        CKEDITOR.plugins.add("enterkey", {
            init: function(a) {
                a.addCommand("enter", { modes: { wysiwyg: 1 }, editorFocus: !1, exec: function(a) { x(a) } });
                a.addCommand("shiftEnter", { modes: { wysiwyg: 1 }, editorFocus: !1, exec: function(a) { x(a, a.activeShiftEnterMode, 1) } });
                a.setKeystroke([
                    [13, "enter"],
        ...
        CKEDITOR.plugins.enterkey = {
            enterBlock: function(a, e, b, l) {
                ...
                if (b = b || y(a)) {
                    ...
                    } else if (c && c.is("pre") && !k) { u(a, e, b, l); return }
                    if (q = b.splitBlock(m)) {
                        a = q.previousBlock;
                        c = q.nextBlock;
                        f = q.wasStartOfBlock;
                        ...
                        if (f || k)
                            if (n(e)) b.moveToElementEditStart(b.getTouchedStartNode());
                                ...
                                if (a) { if (a.is("li") || !w.test(a.getName()) && !a.is("pre")) d = a.clone() } else c && (d = c.clone());
    ...
    (function() {
        ...
        CKEDITOR.plugins.add("entities", {
            afterInit: function(a) {
                function f(b) { return h[b] }

                function g(a) { return "force" != c.entities_processNumerical && b[a] ? b[a] : "\x26#" + a.charCodeAt(0) + ";" }
                var c = a.config;
                if (a = (a = a.dataProcessor) && a.htmlFilter) {
                    ...
                    a.addRules({ text: function(a) { return a.replace(l, f).replace(d, g) } }, { applyToAll: !0, excludeNestedEditable: !0 })
                }
            }
        })
    })();
        ...
        l = CKEDITOR.tools.createClass({
            $: function() {
                ...
                this._.frameLoadedHandler =
                    CKEDITOR.tools.addFunction(function(a) { CKEDITOR.tools.setTimeout(m, 0, this, a) }, this);
            ...
            proto: {
                setData: function(a, e) {
                    ...
                    if (e) this.setHtml(a), this.fixInitialSelection(), b.fire("dataReady");
                        ...
                        d && (a = a.replace(/<!DOCTYPE[^>]*>/i, function(a) { b.docType = f = a; return "" }).replace(/<\?xml\s[^\?]*\?>/i, function(a) { b.xmlDeclaration = a; return "" }));
        ...
        function w(f) {
            ...
            for (var k = this, q = this.database, p = this.context, c, m = f.getSelection(), m = (m && m.getRanges()).createIterator(); c = m.getNextRange();) {
                for (var b = c.getCommonAncestor(); b &&
                    ...
                    if (f.editable().equals(b)) { b = !1; break }
                    b = b.getParent()
                }
    ...
    (function() {
        ...
        function q(c) { for (var b = c.length, a = [], e, f = 0; f < b; f++) e = c.charCodeAt(f), a.push(e); return "String.fromCharCode(" + a.join(",") + ")" }
        ...
        CKEDITOR.plugins.link = {
            ...
            parseLinkAttributes: function(c, b) {
                var a = b && (b.data("cke-saved-href") || b.getAttribute("href")) || "",
                    ...
                    d = {},
                    g;
                a.match(t) && ("encode" == f ? a = a.replace(A, function(a, b, c) { c = c || ""; return "mailto:" + String.fromCharCode.apply(String, b.split(",")) + c.replace(/\\'/g, "'") }) : f && a.replace(B, function(a,
                    b, c) {
                    if (b == e.name) {
                        d.type = "email";
                        a = d.email = {};
                ...
                if (b) {
                    if (a = b.getAttribute("target")) d.target = { type: a.match(z) ? a : "frame", name: a };
                    else if (a = (a = b.data("cke-pa-onclick") || b.getAttribute("onclick")) && a.match(C))
                        for (d.target = { type: "popup", name: a[1] }; f = D.exec(a[2]);) "yes" != f[2] && "1" != f[2] || f[1] in { height: 1, width: 1, top: 1, left: 1 } ? isFinite(f[2]) && (d.target[f[1]] = f[2]) : d.target[f[1]] = !0;
                    null !==
            ...
            getLinkAttributes: function(c, b) {
                ...
                if (b.target)
                    if ("popup" == b.target.type) {
                        for (var a = ["window.open(this.href, '", b.target.name || "", "', '"], h = "resizable status location toolbar menubar fullscreen scrollbars dependent".split(" "), f = h.length, g = function(a) { b.target[a] && h.push(a + "\x3d" + b.target[a]) }, d = 0; d < f; d++) h[d] += b.target[h[d]] ? "\x3dyes" : "\x3dno";
                        g("width");
                        g("left");
                        g("height");
                        g("top");
        ...
        CKEDITOR.removeAnchorCommand.prototype = {
            exec: function(c) {
                ...
                else if (e = CKEDITOR.plugins.link.getSelectedLink(c)) e.hasAttribute("href") ? (e.removeAttributes({ name: 1, "data-cke-saved-name": 1 }), e.removeClass("cke_anchor")) : e.remove(1);
                b.selectBookmarks(a)
            },
    ...
    (function() {
        function K(a, l, d, f) {
            ...
            for (var h = l.root.getDocument(), k, c, b = 0; b < g.length; b++) {
                ...
                k = e[p].parent;
                k.is(this.type) || (c = h.createElement(this.type), k.copyAttributes(c, { start: 1, type: 1 }), c.removeStyle("list-style-type"),
                    e[p].parent = c)
            }
        ...
        function N(a, l, d) {
            function f(b) { if (!(!(c = k[b ? "getFirst" : "getLast"]()) || c.is && c.isBlockBoundary() || !(p = l.root[b ? "getPrevious" : "getNext"](CKEDITOR.dom.walker.invisible(!0))) || p.is && p.isBlockBoundary({ br: 1 }))) a.document.createElement("br")[b ? "insertBefore" : "insertAfter"](c) }
            for (var e = CKEDITOR.plugins.list.listToArray(l.root, d), g = [], b = 0; b < l.contents.length; b++) {
                var h =
                    l.contents[b];
                (h = h.getAscendant("li", !0)) && !h.getCustomData("list_item_processed") && (g.push(h), CKEDITOR.dom.element.setMarker(d, h, "list_item_processed", !0))
        ...
        function F(a, l, d, f) { for (var e, g; e = a[f ? "getLast" : "getFirst"](O);)(g = e.getDirection(1)) !== l.getDirection(1) && e.setAttribute("dir", g), e.remove(), d ? e[f ? "insertBefore" : "insertAfter"](d) : l.append(e, f), d = e }
        ...
        function H(a) { return a.type == CKEDITOR.NODE_ELEMENT && (a.getName() in CKEDITOR.dtd.$block || a.getName() in CKEDITOR.dtd.$listItem) && CKEDITOR.dtd[a.getName()]["#"] }
        ...
        function D(a, l, d) {
            ...
            d.evaluator = function(a) { return t(a) && !z(a) };
        ...
        function A(a) { return (a = a.getLast(t)) && a.type == CKEDITOR.NODE_ELEMENT && a.getName() in u ? a : null }
        var u = { ol: 1, ul: 1 },
            P = CKEDITOR.dom.walker.whitespaces(),
            I = CKEDITOR.dom.walker.bookmark(),
            t = function(a) { return !(P(a) || I(a)) },
        ...
        C.prototype = {
            exec: function(a) {
                function l(a) { return u[a.root.getName()] && !d(a.root, [CKEDITOR.NODE_COMMENT]) }
                ...
                function f(a) {
                    ...
                    a.forEach(function(a) { if (a.type !== CKEDITOR.NODE_COMMENT) return b = !1 }, null, !0);
                    return b
                }
                        ...
                        if (!m.getCustomData("list_block") && !f(m)) {
                            ...
                            for (var y = a.elementPath(m), n = y.elements, r = 0, y = y.blockLimit, q, w = n.length - 1; 0 <= w && (q = n[w]); w--)
                                if (u[q.getName()] && y.contains(q)) {
                                    ...
                                    (n = q.getCustomData("list_group_object")) ? n.contents.push(m): (n = { root: q, contents: [m] }, h.push(n), CKEDITOR.dom.element.setMarker(c, q, "list_group_object", n));
                                    r = 1;
                                    break
                                }
                ...
                a.blockless || (a.addCommand("numberedlist", new C("numberedlist", "ol")), a.addCommand("bulletedlist", new C("bulletedlist", "ul")), a.ui.addButton && (a.ui.addButton("NumberedList", { label: a.lang.list.numberedlist, command: "numberedlist", directional: !0, toolbar: "list,10" }), a.ui.addButton("BulletedList", { label: a.lang.list.bulletedlist, command: "bulletedlist", directional: !0, toolbar: "list,20" })), a.on("key", function(l) {
                    ...
                    if ("wysiwyg" == a.mode && d in { 8: 1, 46: 1 }) {
                        ...
                        if (e && e.collapsed) {
                            ...
                            k.evaluator = function(a) { return t(a) && !z(a) };
                            k.guard = function(a, b) { return !(b && a.type == CKEDITOR.NODE_ELEMENT && a.is("table")) };
                            d = e.clone();
                            if (b) {
                                var c;
    ...
    (function() {
        function n(a, b) { return CKEDITOR.tools.array.reduce(b, function(a, b) { return b(a) }, a) }
        ...
        CKEDITOR.plugins.add("undo", {
            init: function(a) {
                ...
                var d = a.undoManager = new e(a),
                    ...
                    h = a.addCommand("redo", { exec: function() { d.redo() && (a.selectionChange(), this.fire("afterRedo")) }, startDisabled: !0, canUndo: !1 });
                a.setKeystroke([
                    [g[0], "undo"],
                    [g[1], "redo"],
                    [g[2], "redo"]
        ...
        var e = CKEDITOR.plugins.undo.UndoManager = function(a) {
            ...
            this.editor = a;
            this.reset();
            CKEDITOR.env.ie && this.addFilterRule(function(a) { return a.replace(/\s+data-cke-expando=".*?"/g, "") })
        };
        e.prototype = {
            type: function(a, b) {
            ...
            save: function(a, b, c) {
                ...
                if (this.currentImage)
                    if (b.equalsContent(this.currentImage)) { if (a || b.equalsSelection(this.currentImage)) return !1 } else !1 !==
                        c && d.fire("change");
        ...
        e.getKeyGroup = function(a) { var b = e.keyGroups; return p[a] ? b.FUNCTIONAL : b.PRINTABLE };
        ...
        k.prototype = {
            ...
            attachListeners: function() {
                var a = this.undoManager.editor,
                    b = a.editable(),
                    c = this;
                b.attachListener(b, "keydown", function(a) { c.onKeydown(a); if (e.ieFunctionalKeysBug(a.data.getKey())) c.onInput() },
                    null, null, 999);
    ...
    CKEDITOR.config.plugins = 'dialogui,dialog,about,basicstyles,notification,button,toolbar,clipboard,enterkey,entities,floatingspace,wysiwygarea,indent,indentlist,fakeobjects,link,list,undo';
